! function(e, t) {
    ...
    t(document).on(x.CLICK_DATA_API, b, function(e) {
        e.preventDefault();
        var i = e.target;
        t(i).hasClass("btn") || (i = t(i).closest(w)), S._jQueryInterface.call(t(i), "toggle")
    }).on(x.FOCUS_BLUR_DATA_API, b, function(e) {
        var i = t(e.target).closest(w)[0];
        t(i).toggleClass("focus", /^focus(in)?$/.test(e.type))
    }), t.fn[p] = S._jQueryInterface, t.fn[p].Constructor = S, t.fn[p].noConflict = function() {
        return t.fn[p] = y, S._jQueryInterface
    };
    var T = "carousel",
        C = "bs.carousel",
        E = "." + C,
        ...
        N = function() {
            ...
            return i.next = function() {
                ...
                t(this._element).off(E), t.removeData(this._element, C), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, i._getConfig = function(e) {
                return e = r({}, O, e), a.typeCheckConfig(T, e, P), e
                ...
                if (this._touchSupported) {
                    ...
                    t(this._element.querySelectorAll(".carousel-item img")).on(D.DRAG_START, function(e) {
                        return e.preventDefault()
                    }), this._pointerEvent ? (t(this._element).on(D.POINTERDOWN, function(e) {
                        return i(e)
                    }), t(this._element).on(D.POINTERUP, function(e) {
                        return n(e)
                    }), this._element.classList.add("pointer-event")) : (t(this._element).on(D.TOUCHSTART, function(e) {
                        return i(e)
                    ...
                    }), t(this._element).on(D.TOUCHEND, function(e) {
                        return n(e)
                    }))
                }
                ...
                if (r = e === A ? (n = "carousel-item-left", o = "carousel-item-next", "left") : (n = "carousel-item-right", o = "carousel-item-prev", "right"), u && t(u).hasClass(j)) this._isSliding = !1;
                    ...
                    if (t(this._element).hasClass("slide")) {
                        ...
                        t(l).one(a.TRANSITION_END, function() {
                            t(u).removeClass(n + " " + o).addClass(j), t(l).removeClass(j + " " + o + " " + n), s._isSliding = !1, setTimeout(function() {
                ...
                return this.each(function() {
                    ...
                    if (n || (n = new e(this, o), t(this).data(C, n)), "number" == typeof i) n.to(i);
                ...
                if (n) {
                    ...
                    if (o && t(o).hasClass("carousel")) {
                        ...
                        l && (s.interval = !1), e._jQueryInterface.call(t(o), s), l && t(o).data(C).to(l), i.preventDefault()
                    }
                }
            }, o(e, null, [{
                key: "VERSION",
    ...
    t(document).on(D.CLICK_DATA_API, "[data-slide], [data-slide-to]", N._dataApiClickHandler), t(window).on(D.LOAD_DATA_API, function() {
        ...
        return t.fn[T] = I, N._jQueryInterface
    };
    var F = "collapse",
        H = "bs.collapse",
        W = "." + H,
        ...
        $ = function() {
            ...
            return i.toggle = function() {
                ...
                var i, n, o = this;
                if (!(this._isTransitioning || t(this._element).hasClass(X) || (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                    ...
                    if (t(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        t(this._element).removeClass(V).addClass(Y), this._element.style[s] = 0, this._triggerArray.length && t(this._triggerArray).removeClass(G).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var l = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                            c = a.getTransitionDurationFromElement(this._element);
                        t(this._element).one(a.TRANSITION_END, function() {
                            t(o._element).removeClass(Y).addClass(V).addClass(X), o._element.style[s] = "", o.setTransitioning(!1), t(o._element).trigger(U.SHOWN)
                ...
                if (!this._isTransitioning && t(this._element).hasClass(X)) {
                    ...
                    if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", a.reflow(this._element), t(this._element).addClass(Y).removeClass(V).removeClass(X);
                        var o = this._triggerArray.length;
                        if (0 < o)
                            for (var r = 0; r < o; r++) {
                                var s = this._triggerArray[r],
                                    l = a.getSelectorFromElement(s);
                                null !== l && (t([].slice.call(document.querySelectorAll(l))).hasClass(X) || t(s).addClass(G).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[n] = "";
                        var c = a.getTransitionDurationFromElement(this._element);
                        t(this._element).one(a.TRANSITION_END, function() {
                            e.setTransitioning(!1), t(e._element).removeClass(Y).addClass(V).trigger(U.HIDDEN)
                ...
                return (e = r({}, Q, e)).toggle = Boolean(e.toggle), a.typeCheckConfig(F, e, q), e
                ...
                return this.each(function() {
                    ...
                    if (!o && s.toggle && /show|hide/.test(i) && (s.toggle = !1), o || (o = new e(this, s), n.data(H, o)), "string" == typeof i) {
    ...
    }), t.fn[F] = $._jQueryInterface, t.fn[F].Constructor = $, t.fn[F].noConflict = function() {
        return t.fn[F] = B, $._jQueryInterface
    };
    var Z = "dropdown",
        J = "bs.dropdown",
        ee = "." + J,
            ...
            return i.toggle = function(e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (o && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(_e.FOCUSIN), t(this._element).removeClass(xe), t(this._element).off(_e.CLICK_DISMISS), t(this._dialog).off(_e.MOUSEDOWN_DISMISS), o) {
                ...
                return this.each(function() {
                    var o = t(this).data(pe),
                        s = r({}, ve, t(this).data(), "object" == typeof i && i ? i : {});
                    if (o || (o = new e(this, s), t(this).data(pe, o)), "string" == typeof i) {
                        if (void 0 === o[i]) throw new TypeError('No method named "' + i + '"');
                        o[i](n)
    ...
    t(document).on(_e.CLICK_DATA_API, '[data-toggle="modal"]', function(e) {
        ...
        var s = t(i).data(pe) ? "toggle" : r({}, t(i).data(), t(this).data());
        ...
        Ee._jQueryInterface.call(t(i), s, this)
    }), t.fn[fe] = Ee._jQueryInterface, t.fn[fe].Constructor = Ee, t.fn[fe].noConflict = function() {
        return t.fn[fe] = ge, Ee._jQueryInterface
    };
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), o = Object.keys(t), r = [].slice.call(n.body.querySelectorAll("*")), s = function(e, i) {
                ...
                a.forEach(function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(i)) return -1 === ke.indexOf(i) || Boolean(e.nodeValue.match(Ie) || e.nodeValue.match(Oe));
        ...
        Ve = function() {
            ...
            return n.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    s.setAttribute("id", l), this.element.setAttribute("aria-describedby", l), this.setContent(), this.config.animation && t(s).addClass(Qe);
                ...
                var i = this,
                    ...
                    r = function() {
                        i._hoverState !== We && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), t(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), e && e()
                    };
                if (t(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (t(n).removeClass(qe), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[Xe] = !1, this._activeTrigger[Ue] = !1, t(this.tip).hasClass(Qe)) {
                        var s = a.getTransitionDurationFromElement(n);
                        t(n).one(a.TRANSITION_END, r).emulateTransitionEnd(s)
                    } else r();
                    this._hoverState = ""
                }
            }, n.update = function() {
                ...
                this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(Qe + " " + qe)
            }, n.setElementContent = function(e, i) {
                "object" != typeof i || !i.nodeType && !i.jquery ? this.config.html ? (this.config.sanitize && (i = Pe(i, this.config.whiteList, this.config.sanitizeFn)), e.html(i)) : e.text(i) : this.config.html ? t(i).parent().is(e) || e.empty().append(i) : e.text(t(i).text())
            }, n.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(i) {
                    if ("click" === i) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function(t) {
                        ...
                        var n = i === Ue ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                            o = i === Ue ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                var n = this.constructor.DATA_KEY;
                (i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(n, i)), e && (i._activeTrigger["focusout" === e.type ? Xe : Ue] = !1), i._isWithActiveTrigger() || (clearTimeout(i._timeout), i._hoverState = "out", i.config.delay && i.config.delay.hide ? i._timeout = setTimeout(function() {
                ...
                return Object.keys(i).forEach(function(e) {
                    -1 !== Me.indexOf(e) && delete i[e]
                }), "number" == typeof(e = r({}, this.constructor.Default, i, "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), a.typeCheckConfig(Ae, e, this.constructor.DefaultType), e.sanitize && (e.template = Pe(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                return this.each(function() {
                    var n = t(this).data(Le),
                        o = "object" == typeof i && i;
                    if ((n || !/dispose|hide/.test(i)) && (n || (n = new e(this, o), t(this).data(Le, n)), "string" == typeof i)) {
                        if (void 0 === n[i]) throw new TypeError('No method named "' + i + '"');
                        n[i]()
                    }
                })
    ...
    t.fn[Ae] = Ve._jQueryInterface, t.fn[Ae].Constructor = Ve, t.fn[Ae].noConflict = function() {
        return t.fn[Ae] = je, Ve._jQueryInterface
    };
    var Ye = "popover",
        Ge = "bs.popover",
        Ke = "." + Ge,
    ...
    t.fn[Ye] = nt._jQueryInterface, t.fn[Ye].Constructor = nt, t.fn[Ye].noConflict = function() {
        return t.fn[Ye] = $e, nt._jQueryInterface
    };
    var ot = "scrollspy",
        rt = "bs.scrollspy",
        st = "." + rt,
        ...
        vt = function() {
            ...
            return i.refresh = function() {
                ...
                n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(dt), n.addClass(dt)) : (n.addClass(dt), n.parents(ht).prev(ft + ", " + pt).addClass(dt), n.parents(ht).prev(".nav-item").children(ft).addClass(dt)), t(this._scrollElement).trigger(ut.ACTIVATE, {
                    relatedTarget: e
                })
            }, i._clear = function() {
        ...
        Ct = function() {
            ...
            return i.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(xt) || t(this._element).hasClass("disabled"))) {
                    ...
                    if (o) {
                        var s = "UL" === o.nodeName || "OL" === o.nodeName ? Tt : St;
                ...
                var o = this,
                    r = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? t(i).children(St) : t(i).find(Tt))[0],
    ...
    t(document).on(wt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        ...
        return t.fn.tab = bt, Ct._jQueryInterface
    };
    var Et = "toast",
        kt = "bs.toast",
        It = "." + kt,
        ...
        zt = function() {
            ...
            return i.show = function() {
                var e = this;
                t(this._element).trigger(Pt.SHOW), this._config.animation && this._element.classList.add("fade");
                var i = function() {
                    e._element.classList.remove(Lt), e._element.classList.add(At), t(e._element).trigger(Pt.SHOWN), e._config.autohide && e.hide()
                };
                ...
                var i = this;
                this._element.classList.contains(At) && (t(this._element).trigger(Pt.HIDE), e ? this._close() : this._timeout = setTimeout(function() {
                    i._close()
                }, this._config.delay))
            }, i.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(At) && this._element.classList.remove(At), t(this._element).off(Pt.CLICK_DISMISS), t.removeData(this._element, kt), this._element = null, this._config = null
            }, i._getConfig = function(e) {
                return e = r({}, jt, t(this._element).data(), "object" == typeof e && e ? e : {}), a.typeCheckConfig(Et, e, this.constructor.DefaultType), e
            }, i._setListeners = function() {
                var e = this;
                t(this._element).on(Pt.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                    return e.hide(!0)
                })
            }, i._close = function() {
                var e = this,
                    i = function() {
                        e._element.classList.add("hide"), t(e._element).trigger(Pt.HIDDEN)
                    };
                ...
                return this.each(function() {
                    var n = t(this),
                        o = n.data(kt);
                    if (o || (o = new e(this, "object" == typeof i && i), n.data(kt, o)), "string" == typeof i) {
                        if (void 0 === o[i]) throw new TypeError('No method named "' + i + '"');
                        o[i](this)
                    }
                })
    ...
    t.fn[Et] = zt._jQueryInterface, t.fn[Et].Constructor = zt, t.fn[Et].noConflict = function() {
            return t.fn[Et] = Ot, zt._jQueryInterface
        },
        function() {
            if (void 0 === t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = t.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = a, e.Alert = f, e.Button = S, e.Carousel = N, e.Collapse = $, e.Dropdown = he, e.Modal = Ee, e.Popover = nt, e.Scrollspy = vt, e.Tab = Ct, e.Toast = zt, e.Tooltip = Ve, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function(e) {
            ...
            if (null !== o) {
                ...
                e.each(s.axis.split(""), function(e, t) {
                    var i = "x" === t ? "Left" : "Top",
                        ...
                        g = h[r](),
                        v = n.max(d, t);
                    c ? (p[r] = c[o] + (u ? 0 : g - h.offset()[o]), s.margin && (p[r] -= parseInt(f.css("margin" + i), 10) || 0, p[r] -= parseInt(f.css("border" + i + "Width"), 10) || 0), p[r] += m[o] || 0, s.over[o] && (p[r] += f["x" === t ? "width" : "height"]() * s.over[o])) : (i = f[o], p[r] = i.slice && "%" === i.slice(-1) ? parseFloat(i) / 100 * v : i), s.limit && /^\d+$/.test(p[r]) && (p[r] = 0 >= p[r] ? 0 : Math.min(p[r], v)), !e && 1 < s.axis.length && (g === p[r] ? p = {} : a && (l(s.onAfterFirst), p = {}))
                }), l(s.onAfter)
            }
        })
    }, n.max = function(i, n) {
        var o = "scroll" + (r = "x" === n ? "Width" : "Height");
        if (!t(i)) return i[o] - e(i)[r.toLowerCase()]();
        var r = "client" + r,
            s = (a = i.ownerDocument || i.document).documentElement,
            a = a.body;
...
function(e) {
    ...
    function t(t, i, n) {
        ...
        if (r) {
            t && t.preventDefault();
            var s = e(n.target);
            if (!(n.lock && s.is(":animated") || n.onBefore && !1 === n.onBefore(t, r, s))) {
    ...
    return n.defaults = {
        ...
        return (o = e.extend({}, n.defaults, o)).autoscroll && o.hash && location.hash && (o.target && window.scrollTo(0, 0), t(0, location, o)), o.lazy ? this.on(o.event, "a,area", function(e) {
...
function(e) {
    ...
    var t = function(i, n) {
        this.$element = e(i), this.options = e.extend({}, t.DEFAULTS, this.dataOptions(), n), this.init()
    };
    t.DEFAULTS = {
        from: 0,
        to: 0,
    ...
    }, e.fn.countTo = function(i) {
        return this.each(function() {
            var n = e(this),
                o = n.data("countTo"),
                r = "object" == typeof i ? i : {},
                s = "string" == typeof i ? i : "start";
            (!o || "object" == typeof i) && (o && o.stop(), n.data("countTo", o = new t(this, r))), o[s].call(o)
        })
    }
}),
function(e, t) {
    ...
    e.fn.appear = function(t, i) {
        ...
        return this.each(function() {
            ...
            if (i.appeared = !1, t) {
                    ...
                    r = function() {
                        if (i.is(":visible")) {
                            var e = o.scrollLeft(),
                                ...
                                h = i.width(),
                                f = o.width();
                            a + u + c >= t && a <= t + d + c && s + h + l >= e && s <= e + f + l ? i.appeared || i.trigger("appear", n.data) : i.appeared = !1
                        } else i.appeared = !1
                    },
                    s = function() {
                ...
                n.one ? i.one("appear", n.data, s) : i.bind("appear", n.data, s), o.scroll(r), e.fn.appear.checks.push(r), r()
...
function(e, t) {
    ...
    var i = Array.prototype.slice,
        n = e.console,
        o = void 0 === n ? function() {} : function(e) {
            n.error(e)
        };
...
function(e, t) {
    ...
    var t = void 0 === console ? function() {} : function(e) {
            console.error(e)
        },
    ...
    return function t(a) {
        if (function() {
                if (!s) {
                    ...
                    n.appendChild(i);
                    var a = o(i);
                    r = 200 == Math.round(e(a.width)), t.isBoxSizeOuter = r, n.removeChild(i)
                }
        ...
        i.docReady(function() {
            ...
            c.forEach(function(e) {
                ...
                try {
                    ...
                    return void(o && o.error("Error parsing " + s + " on " + e.className + ": " + i))
                }
                var a = new t(e, i);
                d && d.data(e, n, a)
            })
...
function(e, t) {
    ...
    n.extend(p, t.prototype), p._create = function() {
        var t = this.guid = ++d;
        for (var i in this.element.flickityGUID = t, (h[t] = this).selectedIndex = 0, this.restingFrames = 0, this.x = 0, this.velocity = 0, this.originSide = this.options.rightToLeft ? "right" : "left", this.viewport = document.createElement("div"), this.viewport.className = "flickity-viewport", this._createSlider(), (this.options.resize || this.options.watchCSS) && e.addEventListener("resize", this), this.options.on) {
        ...
        if (this.slides = [], this.cells.length) {
            ...
            this.cells.forEach(function(n, o) {
                if (e.cells.length) {
                    ...
                    i.call(this, o, s) || (e.updateTarget(), e = new r(this), this.slides.push(e)), e.addCell(n)
                } else e.addCell(n)
    ...
    return p.setCellAlign = function() {
        ...
        !this.isDragSelect && r < o ? e += t : !this.isDragSelect && s < o && (e -= t), e < 0 ? this.x -= this.slideableWidth : t <= e && (this.x += this.slideableWidth)
...
function(e, t) {
    ...
    function s(e, t, a) {
        ...
        "string" == typeof e && (l = document.querySelectorAll(e)), l ? (this.elements = function(e) {
            return Array.isArray(e) ? e : "object" == typeof e && "number" == typeof e.length ? r.call(e) : [e]
        }(l), this.options = o({}, this.options), "function" == typeof t ? a = t : o(this.options, t), a && this.on("always", a), this.getImages(), i && (this.jqDeferred = new i.Deferred), setTimeout(this.check.bind(this))) : n.error("Bad element for imagesLoaded " + (l || e))
...
function(e, t) {
    ...
    function n(n) {
        if (i(), "string" == typeof n && (n = document.querySelector(n)), n && "object" == typeof n && n.nodeType) {
            ...
            var x = e(r.height);
            return !1 !== x && (l.height = x + (b ? 0 : m + _)), l.innerWidth = l.width - (p + y), l.innerHeight = l.height - (m + _), l.outerWidth = l.width + g, l.outerHeight = l.height + v, l
        }
    }
    var o, r = void 0 === console ? function() {} : function(e) {
            console.error(e)
        },
...
function(e, t) {
    ...
    l.constructor = i, l._create = function() {
        ...
        var e = getComputedStyle(this.element),
            ...
            r = parseFloat(n),
            s = parseFloat(o),
            a = this.layout.size; - 1 != n.indexOf("%") && (r = r / 100 * a.width), -1 != o.indexOf("%") && (s = s / 100 * a.height), r = isNaN(r) ? 0 : r, s = isNaN(s) ? 0 : s, r -= t ? a.paddingLeft : a.paddingRight, s -= i ? a.paddingTop : a.paddingBottom, this.position.x = r, this.position.y = s
...
function() {
    ...
    e = this.jQuery || window.jQuery, t = e(window), e.fn.stick_in_parent = function(i) {
        var n, o, r, s, a, l, c, u, d, h, f;
        for (null == i && (i = {}), f = i.sticky_class, a = i.inner_scrolling, h = i.recalc_every, d = i.parent, u = i.offset_top, c = i.spacer, o = i.bottoming, null == u && (u = 0), null == d && (d = void 0), null == a && (a = !0), null == f && (f = "is_stuck"), n = e(document), null == o && (o = !0), r = function(i, r, s, l, p, m, g, v) {
                var y, _, b, w, x, S, T, C, E, k, I, O;
                if (!i.data("sticky_kit")) {
                    if (i.data("sticky_kit", !0), x = n.height(), T = i.parent(), null != d && (T = T.closest(d)), !T.length) throw "failed to find stick parent";
                    if (y = b = !1, (I = null != c ? c && i.closest(c) : e("<div />")) && I.css("position", i.css("position")), (C = function() {
                            var e, t, o;
                            if (!v && (x = n.height(), e = parseInt(T.css("border-top-width"), 10), t = parseInt(T.css("padding-top"), 10), r = parseInt(T.css("padding-bottom"), 10), s = T.offset().top + e + t, l = T.height(), b && (y = b = !1, null == c && (i.insertAfter(I), I.detach()), i.css({
                                    position: "",
                                    top: "",
                                    width: "",
                                    bottom: ""
                                }).removeClass(f), o = !0), p = i.offset().top - (parseInt(i.css("margin-top"), 10) || 0) - u, m = i.outerHeight(!0), g = i.css("float"), I && I.css({
                        ...
                        })(), m !== l) return w = void 0, S = u, k = h, O = function() {
                        var e, d, _, E;
                        if (!v && (_ = !1, null != k && (0 >= --k && (k = h, C(), _ = !0)), _ || n.height() === x || C(), _ = t.scrollTop(), null != w && (d = _ - w), w = _, b ? (o && (E = _ + m + S > l + s, y && !E && (y = !1, i.css({
                                position: "fixed",
                                bottom: "",
                                top: S
                            }).trigger("sticky_kit:unbottom"))), _ < p && (b = !1, S = u, null == c && ("left" !== g && "right" !== g || i.insertAfter(I), I.detach()), e = {
                                position: "",
                                width: "",
                                top: ""
                            }, i.css(e).removeClass(f).trigger("sticky_kit:unstick")), a && (e = t.height(), m + u > e && !y && (S -= d, S = Math.max(e - m, S), S = Math.min(u, S), b && i.css({
                                top: S + "px"
                            })))) : _ > p && (b = !0, (e = {
                                position: "fixed",
                                top: S
                            }).width = "border-box" === i.css("box-sizing") ? i.outerWidth() + "px" : i.width() + "px", i.css(e).addClass(f), null == c && (i.after(I), "left" !== g && "right" !== g || I.append(i)), i.trigger("sticky_kit:stick")), b && o && (null == E && (E = _ + m + S > l + s), !y && E))) return y = !0, "static" === T.css("position") && T.css({
                            position: "relative"
                        }), i.css({
                            position: "absolute",
                            bottom: r,
                        ...
                        if (v = !0, t.off("touchmove", O), t.off("scroll", O), t.off("resize", E), e(document.body).off("sticky_kit:recalc", E), i.off("sticky_kit:detach", _), i.removeData("sticky_kit"), i.css({
                                position: "",
                                bottom: "",
                                top: "",
                                width: ""
                            }), T.position("position", ""), b) return null == c && ("left" !== g && "right" !== g || i.insertAfter(I), I.remove()), i.removeClass(f)
                    }, t.on("touchmove", O), t.on("scroll", O), t.on("resize", E), e(document.body).on("sticky_kit:recalc", E), i.on("sticky_kit:detach", _), setTimeout(O, 0)
                }
            }, s = 0, l = this.length; s < l; s++) i = this[s], r(e(i));
        return this
    }
}.call(this),
    function(e) {
        ...
        v.prototype = {
            ...
            open: function(i) {
                ...
                if (!t.isOpen) {
                    ...
                    }, 16), t.isOpen = !0, t.updateSize(h), x(u), i
                }
                t.updateItemHTML()
            },
            close: function() {
            ...
            updateItemHTML: function() {
                ...
                t.appendContent(s, n), i.preloaded = !0, x(d, i), o = i.type, t.container.prepend(t.contentContainer), x("AfterChange")
            },
        ...
        var C, E, k, I = "inline",
            O = function() {
                k && (E.after(k.addClass(C)).detach(), k = null)
            };
                ...
                getInline: function(i, n) {
                    if (O(), i.src) {
                        ...
                        if (r.length) {
                            ...
                            s && s.tagName && (E || (C = o.hiddenClass, E = w(C), C = "mfp-" + C), k = r.after(E).detach().removeClass(C)), t.updateStatus("ready")
        ...
        e.magnificPopup.registerModule(A, {
            ...
            proto: {
                initAjax: function() {
                    t.types.push(A), P = t.st.ajax.cursor, b(a + "." + A, D), b("BeforeChange." + A, D)
                },
                getAjax: function(i) {
                    ...
                    var n = e.extend({
                        ...
                        success: function(n, o, r) {
                            ...
                            x("ParseAjax", s), t.appendContent(e(s.data), A), i.finished = !0, L(), t._setFocus(), setTimeout(function() {
                                t.wrap.addClass(p)
        ...
        e.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function(e) {
                    e.img && (e.hasSize = !0, j && clearInterval(j), e.isCheckingImgSize = !1, x("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
                },
                ...
                getImage: function(i, n) {
                    var o = 0,
                        r = function() {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, x("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : s())
                        },
                        s = function() {
        ...
        e.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var i = t.st.gallery,
                        o = ".mfp-gallery";
                    return t.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", b(u + o, function() {
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var e = t.st.retina,
                            i = e.ratio;
                        (i = isNaN(i) ? i() : i) > 1 && (b("ImageHasSize." + W, function(e, t) {
                            t.img.css({
    ...
    function(e) {
        if (!e.hasInitialised) {
            var t = {
                ...
                setCookie: function(e, t, i, n, o, r) {
                    var s = new Date;
            ...
            e.customStyles = {}, e.Popup = function() {
                ...
                function c(i) {
                    var n = this.options,
                        ...
                        r = n.container && 1 === n.container.nodeType ? n.container : document.body;
                    o.innerHTML = i;
                    var s = o.children[0];
                    return s.style.display = "none", t.hasClass(s, "cc-window") && e.hasTransition && t.addClass(s, "cc-invisible"), this.onButtonClick = u.bind(this), s.addEventListener("click", this.onButtonClick), n.autoAttach && (r.firstChild ? r.insertBefore(s, r.firstChild) : r.appendChild(s)), s
                }

                function u(n) {
                    var o = t.traverseDOMPath(n.target, "cc-btn") || n.target;
                    if (t.hasClass(o, "cc-btn")) {
                        var r = o.className.match(new RegExp("\\bcc-(" + i.join("|") + ")\\b")),
                            s = r && r[1] || !1;
                ...
                function d(i, n, o) {
                    if (e.customStyles[i]) ++e.customStyles[i].references;
                        ...
                        document.head.appendChild(c), e.customStyles[i] = {
                            references: 1,
                            element: c.sheet
                        };
                        var u = -1;
                ...
                function p() {
                    ...
                    if ("number" == typeof r && r >= 0) {
                        var s = function(t) {
                            window.pageYOffset > Math.floor(r) && (i(e.status.dismiss), n(!0), window.removeEventListener("scroll", s), this.onWindowScroll = null)
                        };
                    ...
                    if (a) {
                        var c = function(o) {
                            for (var r = !1, s = o.path.length, a = l.length, u = 0; u < s; u++)
                                if (!r)
                                    for (var d = 0; d < a; d++) r || (r = t.hasClass(o.path[u], l[d]));
                            r || (i(e.status.dismiss), n(!0), window.removeEventListener("click", c), this.onWindowClick = null)
                        }.bind(this);
                ...
                return n.prototype.initialise = function(e) {
                    this.options && this.destroy(), t.deepExtend(this.options = {}, m), t.isPlainObject(e) && t.deepExtend(this.options, e), s.call(this) && (this.options.enabled = !1), f(this.options.blacklistPage, location.pathname) && (this.options.enabled = !1), f(this.options.whitelistPage, location.pathname) && (this.options.enabled = !0);
                    ...
                    var i = this.element;
                    e.hasTransition && i && (this.openingTimeout && (clearTimeout(this.openingTimeout), o.bind(this, i)), t.hasClass(i, "cc-invisible") || (this.options.static && (this.element.parentNode.style.maxHeight = ""), this.afterTransition = r.bind(this, i), i.addEventListener(e.transitionEnd, this.afterTransition), t.addClass(i, "cc-invisible")))
                ...
                function n(e, t, i, n, o) {
                    ...
                    if (r.open(n ? "POST" : "GET", e, 1), r.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), Array.isArray(o))
                ...
                return e.prototype.getNextService = function() {
                    ...
                    var o = this;
                    e && e.url && e.callback && (e.isScript ? i : n)(this.setupUrl(e), function(i) {
                ...
                return s.indexOf(a) >= 0 ? void n(new e.Popup(i)) : void e.getCountryCode(i, function(t) {
    ...
    function(e, t, i) {
        ...
        function s(e, i, n, o) {
            ...
            if (parseInt(n, 10))
                for (; n--;)(l = r("div")).id = o ? o[n] : u + (n + 1), d.appendChild(l);
            return (s = r("style")).type = "text/css", s.id = "s" + u, (h.fake ? h : d).appendChild(s), h.appendChild(d), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(t.createTextNode(e)), d.id = u, h.fake && (h.style.background = "", h.style.overflow = "hidden", c = y.style.overflow, y.style.overflow = "hidden", y.appendChild(h)), a = i(d, e), h.fake ? (h.parentNode.removeChild(h), y.style.overflow = c, y.offsetHeight) : d.parentNode.removeChild(d), !!a
        }
        ...
        function d(t, n) {
            ...
            if ("CSS" in e && "supports" in e.CSS) {
                for (; o--;)
                    if (e.CSS.supports(c(t[o]), n)) return !0;
                return !1
            }
            if ("CSSSupportsRule" in e) {
                for (var r = []; o--;) r.push("(" + c(t[o]) + ":" + n + ")");
        ...
        function h(e, t, s, l) {
            ...
            if (l = !n(l, "undefined") && l, !n(s, "undefined")) {
                var u = d(e, s);
                if (!n(u, "undefined")) return u
            }
            for (var h, f, p, m, g, v = ["modernizr", "tspan", "samp"]; !E.style && v.length;) h = !0, E.modElem = r(v.shift()), E.style = E.modElem.style;
            for (p = e.length, f = 0; p > f; f++)
                if (m = e[f], g = E.style[m], a(m, "-") && (m = o(m)), E.style[m] !== i) {
                    if (l || n(s, "undefined")) return c(), "pfx" != t || m;
                    try {
                        E.style[m] = s
                    } catch (e) {}
                    if (E.style[m] != g) return c(), "pfx" != t || m
                } return c(), !1
        }
        ...
        function f(e, t, i, o, r) {
            ...
            return n(t, "string") || n(t, "undefined") ? h(a, t, o, r) : function(e, t, i) {
                var o;
                for (var r in e)
                    if (e[r] in t) return !1 === i ? e[r] : n(o = t[e[r]], "function") ? l(o, i || t) : o;
                return !1
            }(a = (e + " " + T.join(s + " ") + s).split(" "), t, i)
        }
        var p = [],
            m = [],
            g = {
        ...
        g.mq = b, v.addTest("mediaqueries", b("only all"));
        ...
        var S = function(t) {
            ...
            if (!t) return !1;
            if ((n = (t = t.replace(/^@/, "")).replace(/-/g, "_").toUpperCase() + "_RULE") in r) return "@" + t;
            for (var s = 0; o > s; s++) {
                var a = prefixes[s];
                if (a.toUpperCase() + "_" + n in r) return "@-" + a.toLowerCase() + "-" + t
            }
            return !1
        };
        g.atRule = S;
        var T = g._config.usePrefixes ? w.toLowerCase().split(" ") : [];
        g._domPrefixes = T;
        var C = {
            elem: r("modernizr")
        };
        ...
        var k = g.prefixed = function(e, t, i) {
            return 0 === e.indexOf("@") ? S(e) : (-1 != e.indexOf("-") && (e = o(e)), t ? f(e, t, i) : f(e, "pfx"))
        };
        v.addTest("matchmedia", !!k("matchMedia", e)),
            function() {
                var e, t, i, o, r, s;
                for (var a in m)
                    if (m.hasOwnProperty(a)) {
                        if (e = [], (t = m[a]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
                            for (i = 0; i < t.options.aliases.length; i++) e.push(t.options.aliases[i].toLowerCase());
                        for (o = n(t.fn, "function") ? t.fn() : t.fn, r = 0; r < e.length; r++) 1 === (s = e[r].split(".")).length ? v[s[0]] = o : (!v[s[0]] || v[s[0]] instanceof Boolean || (v[s[0]] = new Boolean(v[s[0]])), v[s[0]][s[1]] = o), p.push((o ? "" : "no-") + s.join("-"))
                    }
            }(),
            function(e) {
                var t = y.className,
                    i = v._config.classPrefix || "";
                if (_ && (t = t.baseVal), v._config.enableJSClass) {
                    var n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
                    t = t.replace(n, "$1" + i + "js$2")
                }
                v._config.enableClasses && (t += " " + i + e.join(" " + i), _ ? y.className.baseVal = t : y.className = t)
...
if (function(e) {
        "use strict";
        t = Modernizr.mq("(min-width: 0px)") ? function(e) {
            ...
            preloader: function() {
                e(".loader").fadeOut(), e(".loader-mask").delay(350).animate({
                    height: 0
            ...
            onepageNav: function() {
                e("#onepage-nav").on("click", "li > a", function() {
            ...
            scrollToTopScroll: function() {
                i.scrollTop() >= 50 ? r.addClass("show") : r.removeClass("show")
            },
            ...
            cookies: function() {
                window.cookieconsent.initialise({
                    ...
                    position: "bottom"
                }), e(".cc-banner").wrapInner("<div class='cc-container container'></div>")
            },
            counters: function() {
                e(".results__number").appear(function() {
                    e(this).countTo({
                        speed: 3e3,
                        refreshInterval: 60,
                        formatter: function(e, t) {
            ...
            stickyNavbar: function() {
                var t = e(".nav--sticky");
                i.scrollTop() > 190 ? t.addClass("sticky") : t.removeClass("sticky"), i.scrollTop() > 200 ? t.addClass("offset") : t.removeClass("offset"), i.scrollTop() > 500 ? t.addClass("scrolling") : t.removeClass("scrolling")
            },
            mobileNavigation: function() {
                var t = e(".nav__dropdown"),
                    i = e(".nav__dropdown-menu");
                e(".nav__dropdown-trigger").on("click", function() {
                    var t = e(this);
                    t.toggleClass("nav__dropdown-trigger--is-open"), t.next(i).slideToggle(), t.attr("aria-expanded", function(e, t) {
                    ...
                    e.stopPropagation(), i.removeClass("hide-dropdown")
                }))
            },
            isotopeFilter: function() {
                let t = e("#project-grid, #masonry-grid");
                e(".project-filter").on("click", "a", function(i) {
                    i.preventDefault();
                    var n = e(this).attr("data-filter");
                    t.isotope({
                        filter: n
                    }), e(".project-filter a").removeClass("active"), e(this).closest("a").addClass("active")
                })
            },
            isotope: function() {
                let t = e("#project-grid");
                t.imagesLoaded(function() {
                    t.isotope({
            ...
            lightbox: function() {
                e(".lightbox-img, .lightbox-video").magnificPopup({
                    callbacks: {
                ...
                }), e(".single-video-lightbox").magnificPopup({
                    type: "iframe",
                    closeBtnInside: !1,
                    removalDelay: 500,
                    callbacks: {
                        beforeOpen: function() {
                            this.st.iframe.markup = this.st.iframe.markup.replace("mfp-iframe-scaler", "mfp-iframe-scaler mfp-with-anim"), this.st.mainClass = this.st.el.attr("data-effect")
                        }
                    },
                    fixedContentPos: !1
                })
            ...
            accordions: function() {
                ...
                function i(t) {
                    e(t.target).prev(".accordion__heading").find("a").toggleClass("accordion--is-open accordion--is-closed")
                }
                t.on("hide.bs.collapse", i), t.on("show.bs.collapse", i)
            },
            ...
            stickyFooter: function() {
                var i = e(".footer"),
                    n = e(".footer-placeholder"),
                    o = i.height();
                t(992) ? n.height(o) : n.height(0)
            },
            animate: function() {
                e(".animate").appear(function() {
                    e(this).addClass("animate--animated")
                }, {
                    accY: -100
                })
            },
            contactForm: function() {
                var t = e("#contact-form__message");
                e("#contact-form__submit").on("click", function(i) {
                    i.preventDefault();
                    var n = e(this);
                    e.ajax({
                        type: "POST",
        ...
        var t, i = e(window),
            ...
            o = e("body"),
            r = e("#back-to-top");
        e(document).ready(DEOTHEMES.documentOnReady.init), i.on("load", DEOTHEMES.windowOnLoad.init), i.on("resize", DEOTHEMES.windowOnResize.init), i.on("scroll", DEOTHEMES.windowOnScroll.init)
    }(jQuery), function(e) {
        ...
        var t = "left",
            ...
            T = window.navigator.pointerEnabled || window.navigator.msPointerEnabled,
            C = "TouchSwipe";

        function E(E, k) {
            var I = x || T || !k.fallbackToMouseEvents,
                O = I ? T ? S ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown",
                P = I ? T ? S ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
                A = I ? T ? S ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup",
                L = I ? null : "mouseleave",
                D = T ? S ? "MSPointerCancel" : "pointercancel" : "touchcancel",
                j = 0,
                z = null,
                R = 0,
                M = 0,
                ...
                J = null;
            try {
                Q.bind(O, ee), Q.bind(D, ne)
            } catch (t) {
                e.error("events not supported " + O + "," + D + " on jQuery.swipetp")
            }

            function ee(r) {
                if (!0 !== Q.data(C + "_intouch") && !(e(r.target).closest(k.excludedElements, Q).length > 0)) {
                    var s, a = r.originalEvent ? r.originalEvent : r,
                        l = a.touches,
                        c = l ? l[0] : a;
                    return q = y, l ? U = l.length : r.preventDefault(), j = 0, z = null, W = null, R = 0, M = 0, N = 0, F = 1, H = 0, X = function() {
                        ...
                        var e = {};
                        return e[t] = Oe(t), e[i] = Oe(i), e[n] = Oe(n), e[o] = Oe(o), e
                    }(), Se(), !l || U === k.fingers || k.fingers === g || fe() ? (Ee(0, c), V = Le(), 2 == U && (Ee(1, l[1]), M = N = Ae(X[0].start, X[1].start)), (k.swipeStatus || k.pinchStatus) && (s = ae(a, q))) : s = !1, !1 === s ? (ae(a, q = w), s) : (k.hold && (J = setTimeout(e.proxy(function() {
                        Q.trigger("hold", [a.target]), k.hold && (s = k.hold.call(Q, a, a.target))
                    }, this), k.longTapThreshold)), Ce(!0), null)
                }
            }
            ...
            function te(c) {
                ...
                if (q !== b && q !== w && !Te()) {
                    var d, h = u.touches,
                        f = ke(h ? h[0] : u);
                    if (Y = Le(), h && (U = h.length), k.hold && clearTimeout(J), q = _, 2 == U && (0 == M ? (Ee(1, h[1]), M = N = Ae(X[0].start, X[1].start)) : (ke(h[1]), N = Ae(X[0].end, X[1].end), X[0].end, X[1].end, W = F < 1 ? s : r), F = function(e, t) {
                            return (t / e * 1).toFixed(2)
                        }(M, N), H = Math.abs(M - N)), U === k.fingers || k.fingers === g || !h || fe()) {
                        if (function(e, r) {
                                if (!1 === k.preventDefaultEvents) return;
                                if (k.allowPageScroll === a) e.preventDefault();
                                else {
                                    var s = k.allowPageScroll === l;
                                    switch (r) {
                                        case t:
                                            (k.swipeLeft && s || !s && k.allowPageScroll != p) && e.preventDefault();
                                            break;
                                        case i:
                                            (k.swipeRight && s || !s && k.allowPageScroll != p) && e.preventDefault();
                                            break;
                                        case n:
                                            (k.swipeUp && s || !s && k.allowPageScroll != m) && e.preventDefault();
                                            break;
                                        case o:
                                            (k.swipeDown && s || !s && k.allowPageScroll != m) && e.preventDefault()
                                    }
                                }
                            }(c, z = function(e, r) {
                                var s = function(e, t) {
                                ...
                                return s <= 45 && s >= 0 ? t : s <= 360 && s >= 315 ? t : s >= 135 && s <= 225 ? i : s > 45 && s < 135 ? o : n
                            }(f.start, f.end)), j = function(e, t) {
                                return Math.round(Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2)))
                            }(f.start, f.end), R = Pe(), function(e, t) {
                                t = Math.max(t, Ie(e)), B[e].distance = t
                            }(z, j), (k.swipeStatus || k.pinchStatus) && (d = ae(u, q)), !k.triggerOnTouchEnd || k.triggerOnTouchLeave) {
                            var v = !0;
                            ...
                            }!k.triggerOnTouchEnd && v ? q = se(_) : k.triggerOnTouchLeave && !v && (q = se(b)), q != w && q != b || ae(u, q)
                        }
                    } else ae(u, q = w);
                    !1 === d && ae(u, q = w)
                }
            ...
            function ie(e) {
                var t = e.originalEvent ? e.originalEvent : e,
                    i = t.touches;
                return i && i.length ? (G = Le(), K = event.touches.length + 1, !0) : (Te() && (U = K), Y = Le(), R = Pe(), ue() || !ce() ? ae(t, q = w) : k.triggerOnTouchEnd || 0 == k.triggerOnTouchEnd && q === _ ? (e.preventDefault(), ae(t, q = b)) : !k.triggerOnTouchEnd && be() ? le(t, q = b, d) : q === _ && ae(t, q = w), Ce(!1), null)
            }

            function ne() {
                U = 0, Y = 0, V = 0, M = 0, N = 0, F = 1, Se(), Ce(!1)
            }

            function oe(e) {
                var t = e.originalEvent ? e.originalEvent : e;
                k.triggerOnTouchLeave && ae(t, q = se(b))
            }

            function re() {
                Q.unbind(O, ee), Q.unbind(D, ne), Q.unbind(P, te), Q.unbind(A, ie), L && Q.unbind(L, oe), Ce(!1)
            }
            ...
            function se(e) {
                var t = e,
                    ...
                    n = ce(),
                    o = ue();
                return !i || o ? t = w : !n || e != _ || k.triggerOnTouchEnd && !k.triggerOnTouchLeave ? !n && e == b && k.triggerOnTouchLeave && (t = w) : t = b, t
            }

            function ae(e, t) {
                var i, n = e.touches;
                return ve() || ge() || pe() || fe() ? ((ve() || ge()) && (i = le(e, t, c)), (pe() || fe()) && !1 !== i && (i = le(e, t, u))) : xe() && we() && !1 !== i ? i = le(e, t, h) : R > k.longTapThreshold && j < v && k.longTap && !1 !== i ? i = le(e, t, f) : 1 !== U && x || !(isNaN(j) || j < k.threshold) || !be() || !1 === i || (i = le(e, t, d)), t === w && ne(), t === b && (n && n.length || ne()), i
            }

            function le(a, l, p) {
                var m;
                if (p == c) {
                    if (Q.trigger("swipeStatus", [l, z || null, j || 0, R || 0, U, X]), k.swipeStatus && !1 === (m = k.swipeStatus.call(Q, a, l, z || null, j || 0, R || 0, U, X))) return !1;
                    if (l == b && me()) {
                        if (Q.trigger("swipe", [z, j, R, U, X]), k.swipe && !1 === (m = k.swipe.call(Q, a, z, j, R, U, X))) return !1;
                        switch (z) {
                            case t:
                                Q.trigger("swipeLeft", [z, j, R, U, X]), k.swipeLeft && (m = k.swipeLeft.call(Q, a, z, j, R, U, X));
                                break;
                            case i:
                                Q.trigger("swipeRight", [z, j, R, U, X]), k.swipeRight && (m = k.swipeRight.call(Q, a, z, j, R, U, X));
                                break;
                            case n:
                                Q.trigger("swipeUp", [z, j, R, U, X]), k.swipeUp && (m = k.swipeUp.call(Q, a, z, j, R, U, X));
                                break;
                            case o:
                                Q.trigger("swipeDown", [z, j, R, U, X]), k.swipeDown && (m = k.swipeDown.call(Q, a, z, j, R, U, X))
                        }
                    }
                }
                if (p == u) {
                    if (Q.trigger("pinchStatus", [l, W || null, H || 0, R || 0, U, F, X]), k.pinchStatus && !1 === (m = k.pinchStatus.call(Q, a, l, W || null, H || 0, R || 0, U, F, X))) return !1;
                    if (l == b && he()) switch (W) {
                        case r:
                            Q.trigger("pinchIn", [W || null, H || 0, R || 0, U, F, X]), k.pinchIn && (m = k.pinchIn.call(Q, a, W || null, H || 0, R || 0, U, F, X));
                            break;
                        case s:
                            Q.trigger("pinchOut", [W || null, H || 0, R || 0, U, F, X]), k.pinchOut && (m = k.pinchOut.call(Q, a, W || null, H || 0, R || 0, U, F, X))
                    }
                }
                return p == d ? l !== w && l !== b || (clearTimeout(Z), clearTimeout(J), we() && !xe() ? ($ = Le(), Z = setTimeout(e.proxy(function() {
                    $ = null, Q.trigger("tap", [a.target]), k.tap && (m = k.tap.call(Q, a, a.target))
                }, this), k.doubleTapThreshold)) : ($ = null, Q.trigger("tap", [a.target]), k.tap && (m = k.tap.call(Q, a, a.target)))) : p == h ? l !== w && l !== b || (clearTimeout(Z), $ = null, Q.trigger("doubletap", [a.target]), k.doubleTap && (m = k.doubleTap.call(Q, a, a.target))) : p == f && (l !== w && l !== b || (clearTimeout(Z), $ = null, Q.trigger("longtap", [a.target]), k.longTap && (m = k.longTap.call(Q, a, a.target)))), m
            }

            function ce() {
                var e = !0;
                return null !== k.threshold && (e = j >= k.threshold), e
            }

            function ue() {
                var e = !1;
                return null !== k.cancelThreshold && null !== z && (e = Ie(z) - j >= k.cancelThreshold), e
            }

            function de() {
                return !k.maxTimeThreshold || !(R >= k.maxTimeThreshold)
            }

            function he() {
                var e = ye(),
                    t = _e(),
                    i = null === k.pinchThreshold || H >= k.pinchThreshold;
                return e && t && i
            }
            ...
            function ye() {
                return U === k.fingers || k.fingers === g || !x
            }
            ...
            function xe() {
                if (null == $) return !1;
                var e = Le();
                return we() && e - $ <= k.doubleTapThreshold
            }
            ...
            function Te() {
                var e = !1;
                G && (Le() - G <= k.fingerReleaseThreshold && (e = !0));
                return e
            }

            function Ce(e) {
                !0 === e ? (Q.bind(P, te), Q.bind(A, ie), L && Q.bind(L, oe)) : (Q.unbind(P, te, !1), Q.unbind(A, ie, !1), L && Q.unbind(L, oe, !1)), Q.data(C + "_intouch", !0 === e)
            }
            ...
            this.enable = function() {
                return Q.bind(O, ee), Q.bind(D, ne), Q
            }, this.disable = function() {
                return re(), Q
            }, this.destroy = function() {
                re(), Q.data(C, null), Q = null
    ...
    if (!o.TweenLite) {
        var r, s, a, l, c, u = function(e) {
            ...
            v = function(n, r, s, a) {
                ...
                this.check = function(c) {
                    for (var d, h, f, p, m, y = r.length, _ = y; --y > -1;)(d = g[r[y]] || new v(r[y], [])).gsClass ? (l[y] = d.gsClass, _--) : c && d.sc.push(this);
                    if (0 === _ && s) {
                        if (f = (h = ("com.greensock." + n).split(".")).pop(), p = u(h.join("."))[f] = this.gsClass = s.apply(s, l), a)
                            if (o[f] = i[f] = p, !(m = "undefined" != typeof module && module.exports) && "function" == typeof define && define.amd) define((e.GreenSockAMDPath ? e.GreenSockAMDPath + "/" : "") + n.split(".").pop(), [], function() {
                                return p
                            });
                            else if (m)
                            if (n === t)
                                for (y in module.exports = i[t] = p, i) p[y] = i[y];
                            else i[t] && (i[t][f] = p);
        ...
        var b = [0, 0, 1, 1],
            ...
            S = w.register = function(e, t, i, n) {
                for (var o, r, s, a, l = t.split(","), c = l.length, u = (i || "easeIn,easeOut,easeInOut").split(","); --c > -1;)
                    for (r = l[c], o = n ? _("easing." + r, null, !0) : d.easing[r] || {}, s = u.length; --s > -1;) a = u[s], x[r + "." + a] = x[a + r] = o[a] = e.getRatio ? e : e[a] || new e
            };
        for ((a = w.prototype)._calcEnd = !1, a.getRatio = function(e) {
            ...
            }, s = (r = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --s > -1;) a = r[s] + ",Power" + s, S(new w(null, null, 1, s), a, "easeOut", !0), S(new w(null, null, 2, s), a, "easeIn" + (0 === s ? ",easeNone" : "")), S(new w(null, null, 3, s), a, "easeInOut");
        x.linear = d.easing.Linear.easeIn, x.swing = d.easing.Quad.easeInOut;
        var T = _("events.EventDispatcher", function(e) {
            this._listeners = {}, this._eventTarget = e || this
        });
        (a = T.prototype).addEventListener = function(e, t, i, n, o) {
            o = o || 0;
            var r, s, a = this._listeners[e],
                u = 0;
            for (this !== l || c || l.wake(), null == a && (this._listeners[e] = a = []), s = a.length; --s > -1;)(r = a[s]).c === t && r.s === i ? a.splice(s, 1) : 0 === u && r.pr < o && (u = s + 1);
            a.splice(u, 0, {
                c: t,
                s: i,
                up: n,
        ...
        var C = e.requestAnimationFrame,
            ...
            I = k();
        for (s = (r = ["ms", "moz", "webkit", "o"]).length; --s > -1 && !C;) C = e[r[s] + "RequestAnimationFrame"], E = e[r[s] + "CancelAnimationFrame"] || e[r[s] + "CancelRequestAnimationFrame"];
        _("Ticker", function(e, t) {
            var i, o, r, s, a, u = this,
                ...
                v = function(e) {
                    var t, n, l = k() - I;
                    l > m && (d += l - g), I += l, u.time = (I - d) / 1e3, t = u.time - a, (!i || t > 0 || !0 === e) && (u.frame++, a += t + (t >= s ? .004 : s - t), n = !0), !0 !== e && (r = o(v)), n && u.dispatchEvent("tick")
                };
            T.call(u), u.time = u.frame = 0, u.tick = function() {
                ...
                null != r && (f && E ? E(r) : clearTimeout(r), o = p, r = null, u === l && (c = !1))
            }, u.wake = function(e) {
                null !== r ? u.sleep() : e ? d += -I + (I = k()) : u.frame > 10 && (I = k() - m + 5), o = 0 === i ? p : f && C ? C : function(e) {
        ...
        l = O.ticker = new d.Ticker, (a = O.prototype)._dirty = a._gc = a._initted = a._paused = !1, a._totalTime = a._time = 0, a._rawPrevTime = -1, a._next = a._last = a._onUpdate = a._timeline = a.timeline = null, a._paused = !1;
        var P = function() {
            c && k() - I > 2e3 && l.wake(), setTimeout(P, 2e3)
        };
        P(), a.play = function(e, t) {
            ...
            if (this._timeline) {
                ...
                this._gc && this._enabled(!0, !1), (this._totalTime !== e || 0 === this._duration) && (j.length && G(), this.render(e, t, !1), j.length && G())
            }
            return this
        ...
        var A = _("core.SimpleTimeline", function(e) {
            O.call(this, 0, e), this.autoRemoveChildren = this.smoothChildTiming = !0
        });
        (a = A.prototype = new O).constructor = A, a.kill()._gc = !1, a._first = a._last = a._recent = null, a._sortChildren = !1, a.add = a.insert = function(e, t, i, n) {
            var o, r;
        ...
        var L = _("TweenLite", function(t, i, n) {
                ...
                if (this._overwrite = l = null == l ? U[L.defaultOverwrite] : "number" == typeof l ? l >> 0 : U[l], (a || t instanceof Array || t.push && m(t)) && "number" != typeof t[0])
                    for (this._targets = s = f(t), this._propLookup = [], this._siblings = [], o = 0; o < s.length; o++)(r = s[o]) ? "string" != typeof r ? r.length && r !== e && r[0] && (r[0] === e || r[0].nodeType && r[0].style && !r.nodeType) ? (s.splice(o--, 1), this._targets = s = s.concat(f(r))) : (this._siblings[o] = K(r, this, !1), 1 === l && this._siblings[o].length > 1 && Z(r, this, null, 1, this._siblings[o])) : "string" == typeof(r = s[o--] = L.selector(r)) && s.splice(o + 1, 1) : s.splice(o--, 1);
                else this._propLookup = {}, this._siblings = K(t, this, !1), 1 === l && this._siblings.length > 1 && Z(t, this, null, 1, this._siblings);
        ...
        (a = L.prototype = new O).constructor = L, a.kill()._gc = !1, a.ratio = 0, a._firstPT = a._targets = a._overwrittenProps = a._startAt = null, a._notifyPluginsOfEnabled = a._lazy = !1, L.version = "1.19.1", L.defaultEase = a._ease = new w(null, null, 1, 1), L.defaultOverwrite = "auto", L.ticker = l, L.autoSleep = 120, L.lagSmoothing = function(e, t) {
            l.lagSmoothing(e, t)
        ...
        var j = [],
            ...
            N = function(e, t, i, n) {
                ...
                return (f += t.substr(h)) && d.push(f), d.setRatio = M, d
            },
            F = function(e, t, i, n, o, r, s, a, l) {
                ...
                return ("number" != typeof d || "number" != typeof n && !h) && (s || isNaN(d) || !h && isNaN(n) || "boolean" == typeof d || "boolean" == typeof n ? (f.fp = s, f = {
                    t: N(d, h ? f.s + f.c : n, a || L.defaultStringFilter, f),
                    p: "setRatio",
                    s: 0,
                    c: 1,
                    f: 2,
            ...
            X = O._rootFramesTimeline = new A,
            V = O._rootTimeline = new A,
            Y = 30,
            G = H.lazyRender = function() {
                var e, t = j.length;
                for (z = {}; --t > -1;)(e = j[t]) && !1 !== e._lazy && (e.render(e._lazy[0], e._lazy[1], !0), e._lazy = !1);
                j.length = 0
            };
        V._startTime = l.time, X._startTime = l.frame, V._active = X._active = !0, setTimeout(G, 1), O._updateRoot = L.render = function() {
            var e, t, i;
            if (j.length && G(), V.render((l.time - V._startTime) * V._timeScale, !1, !1), X.render((l.frame - X._startTime) * X._timeScale, !1, !1), j.length && G(), l.frame >= Y) {
                for (i in Y = l.frame + (parseInt(L.autoSleep, 10) || 120), B) {
                    for (e = (t = B[i].tweens).length; --e > -1;) t[e]._gc && t.splice(e, 1);
                    0 === t.length && delete B[i]
                }
                if ((!(i = V._first) || i._paused) && L.autoSleep && !X._first && 1 === l._listeners.tick.length) {
        ...
        var K = function(e, t, i) {
                ...
                if (B[r || (e._gsTweenID = r = "t" + Q++)] || (B[r] = {
                        target: e,
                        tweens: []
                    }), t && ((n = B[r].tweens)[o = n.length] = t, i))
                    for (; --o > -1;) n[o] === t && n.splice(o, 1);
                return B[r].tweens
            },
            $ = function(e, t, i, n) {
                var o, r, s = e.vars.onOverwrite;
                return s && (o = s(e, t, i, n)), (s = L.onOverwrite) && (r = s(e, t, i, n)), !1 !== o && !1 !== r
            },
            Z = function(e, t, i, n, o) {
                ...
                var c, u = t._startTime + h,
                    ...
                    f = 0,
                    p = 0 === t._duration;
                for (r = o.length; --r > -1;)(a = o[r]) === t || a._gc || a._paused || (a._timeline !== t._timeline ? (c = c || J(t, 0, p), 0 === J(a, c, p) && (d[f++] = a)) : a._startTime <= u && a._startTime + a.totalDuration() / a._timeScale > u && ((p || !a._initted) && u - a._startTime <= 2e-10 || (d[f++] = a)));
                for (r = f; --r > -1;)
            ...
            J = function(e, t, i) {
                ...
                return (r /= o) > t ? r - t : i && r === t || !e._initted && 2 * h > r - t ? h : (r += e.totalDuration() / e._timeScale / o) > t + h ? 0 : r - t - h
            };
        a._init = function() {
            ...
            if (s.startAt) {
                ...
                if (o.overwrite = !1, o.immediateRender = !0, o.lazy = c && !1 !== s.lazy, o.startAt = o.delay = null, this._startAt = L.to(this.target, 0, o), c)
            ...
            var s, a, l, c, u, d;
            if (null == t) return !1;
            for (s in z[t._gsTweenID] && G(), this.vars.css || t.style && t !== e && t.nodeType && W.css && !1 !== this.vars.autoCSS && function(e, t) {
                    var i, n = {};
                    for (i in e) q[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!W[i] || W[i] && W[i]._autoCSS) || (n[i] = e[i], delete e[i]);
                    e.css = n
            ...
            } else i[s] = F.call(this, t, s, "get", d, s, 0, null, this.vars.stringFilter, r);
            return o && this._kill(o, t) ? this._initProps(t, i, n, o, r) : this._overwrite > 1 && this._firstPT && n.length > 1 && Z(t, this, i, this._overwrite, n) ? (this._kill(i, t), this._initProps(t, i, n, o, r)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (z[t._gsTweenID] = !0), l)
        }, a.render = function(e, t, i) {
            ...
            else if (1e-7 > e) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === l && c > 0) && (o = "onReverseComplete", n = this._reversed), 0 > e && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (c >= 0 && (c !== h || "isPause" !== this.data) && (i = !0), this._rawPrevTime = s = !t || e || c === e ? e : h)), this._initted || (i = !0);
            else if (this._totalTime = this._time = e, this._easeType) {
                var u = e / l,
                    d = this._easeType,
                    f = this._easePower;
                (1 === d || 3 === d && u >= .5) && (u = 1 - u), 3 === d && (u *= 2), 1 === f ? u *= u : 2 === f ? u *= u * u : 3 === f ? u *= u * u * u : 4 === f && (u *= u * u * u * u), this.ratio = 1 === d ? 1 - u : 2 === d ? u : .5 > e / l ? u / 2 : 1 - u / 2
            } else this.ratio = this._ease.getRatio(e / l);
            if (this._time !== a || i) {
                if (!this._initted) {
                    if (this._init(), !this._initted || this._gc) return;
                    if (!i && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = a, this._rawPrevTime = c, j.push(this), void(this._lazy = [e, t]);
                ...
                this._onUpdate && (0 > e && this._startAt && -1e-4 !== e && this._startAt.render(e, t, i), t || (this._time !== a || n || i) && this._callback("onUpdate")), o && (!this._gc || i) && (0 > e && this._startAt && !this._onUpdate && -1e-4 !== e && this._startAt.render(e, t, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !t && this.vars[o] && this._callback(o), 0 === l && this._rawPrevTime === h && s !== h && (this._rawPrevTime = 0))
            }
        }, a._kill = function(e, t, i) {
            if ("all" === e && (e = null), null == e && (null == t || t === this.target)) return this._lazy = !1, this._enabled(!1, !1);
            t = "string" != typeof t ? t || this._targets || this.target : L.selector(t) || t;
            var n, o, r, s, a, l, c, u, d, h = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline;
            if ((m(t) || D(t)) && "number" != typeof t[0])
                ...
                if (a) {
                    if (c = e || a, u = e !== o && "all" !== o && e !== a && ("object" != typeof e || !e._tempKill), i && (L.onOverwrite || this.vars.onOverwrite)) {
                        for (r in c) a[r] && (d || (d = []), d.push(r));
                        if ((d || !e) && !$(this, i, t, d)) return !1
                    }
                    for (r in c)(s = a[r]) && (h && (s.f ? s.t[s.p](s.s) : s.t[s.p] = s.s, l = !0), s.pg && s.t._kill(c) && (l = !0), s.pg && 0 !== s.t._overwriteProps.length || (s._prev ? s._prev._next = s._next : s === this._firstPT && (this._firstPT = s._next), s._next && (s._next._prev = s._prev), s._next = s._prev = null), delete a[r]), u && (o[r] = 1);
            ...
            for (var n = L.getTweensOf(e, t), o = n.length; --o > -1;) n[o]._kill(i, e)
        };
        ...
        if (a = ee.prototype, ee.version = "1.19.0", ee.API = 2, a._firstPT = null, a._addTween = F, a.setRatio = M, a._kill = function(e) {
                ...
                for (t in a.constructor = s, s.API = e.API, r) "function" == typeof e[t] && (a[r[t]] = e[t]);
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(e, t, i) {
            var n = function(e) {
                ...
                p = s.pauseCallback = function(e, t, i, n) {
                    var r, s = e._timeline,
                        a = s._totalTime,
                        l = e._startTime,
                        c = 0 > e._rawPrevTime || 0 === e._rawPrevTime && s._reversed,
                        u = c ? 0 : o,
                        h = c ? o : 0;
                    if (t || !this._forcingPlayhead) {
                        for (s.pause(l), r = e._prev; r && r._startTime === l;) r._rawPrevTime = h, r = r._prev;
                        for (r = e._next; r && r._startTime === l;) r._rawPrevTime = u, r = r._next;
                        t && t.apply(n || s.vars.callbackScope || s, i || d), (this._forcingPlayhead || !s._paused) && s.seek(a)
                    }
                },
                m = function(e) {
                    var t, i = [],
            ...
            return n.version = "1.17.0", g.constructor = n, g.kill()._gc = g._forcingPlayhead = !1, g.to = function(e, t, n, o) {
            ...
            }, g.staggerTo = function(e, t, o, r, s, l, c, u) {
                var d, h = new n({
                    onComplete: l,
                    onCompleteParams: c,
                    callbackScope: u,
                ...
                for ("string" == typeof e && (e = i.selector(e) || e), a(e = e || []) && (e = m(e)), 0 > (r = r || 0) && ((e = m(e)).reverse(), r *= -1), d = 0; e.length > d; d++) o.startAt && (o.startAt = f(o.startAt)), h.to(e[d], t, f(o), d * r);
                return this.add(h, s)
                ...
                if ("number" != typeof r && (r = this._parseTimeOrLabel(r, 0, !0, o)), !(o instanceof e)) {
                    if (o instanceof Array || o && o.push && l(o)) {
                        for (s = s || "normal", a = a || 0, c = r, u = o.length, d = 0; u > d; d++) l(h = o[d]) && (h = new n({
                            tweens: h
                ...
                var r = i.delayedCall(0, p, ["{self}", t, n, o], this);
                ...
                var n, r, s, a, l, d = this._dirty ? this.totalDuration() : this._totalDuration,
                    h = this._time,
                    f = this._startTime,
                    p = this._timeScale,
                    m = this._paused;
                if (e >= d) this._totalTime = this._time = d, this._reversed || this._hasPausedChild() || (r = !0, a = "onComplete", l = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 === e || 0 > this._rawPrevTime || this._rawPrevTime === o) && this._rawPrevTime !== e && this._first && (l = !0, this._rawPrevTime > o && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !t || e || this._rawPrevTime === e ? e : o, e = d + 1e-4;
                else if (1e-7 > e)
                ...
                if (this._time !== h && this._first || i || l) {
                    if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== h && e > 0 && (this._active = !0), 0 === h && this.vars.onStart && 0 !== this._time && (t || this._callback("onStart")), this._time >= h)
                        ...
                        for (n = this._last; n && (s = n._prev, !this._paused || m);)(n._active || h >= n._startTime && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = s;
                    this._onUpdate && (t || (c.length && u(), this._callback("onUpdate"))), a && (this._gc || (f === this._startTime || p !== this._timeScale) && (0 === this._time || d >= this.totalDuration()) && (r && (c.length && u(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !t && this.vars[a] && this._callback(a)))
                }
                ...
                o = o || -9999999999;
                for (var r = [], s = this._first, a = 0; s;) o > s._startTime || (s instanceof i ? !1 !== t && (r[a++] = s) : (!1 !== n && (r[a++] = s), !1 !== e && (a = (r = r.concat(s.getChildren(!0, t, n))).length))), s = s._next;
                return r
            }, g.getTweensOf = function(e, t) {
                var n, o, r = this._gc,
                    s = [],
                    a = 0;
                for (r && this._enabled(!0, !0), o = (n = i.getTweensOf(e)).length; --o > -1;)(n[o].timeline === this || t && this._contains(n[o])) && (s[a++] = n[o]);
                ...
                if (!arguments.length) {
                    if (this._dirty) {
                        for (var t, i, n = 0, o = this._last, r = 999999999999; o;) t = o._prev, o._dirty && o.totalDuration(), o._startTime > r && this._sortChildren && !o._paused ? this.add(o, o._startTime - o._delay) : r = o._startTime, 0 > o._startTime && !o._paused && (n -= o._startTime, this._timeline.smoothChildTiming && (this._startTime += o._startTime / this._timeScale), this.shiftChildren(-o._startTime, !1, -9999999999), r = 0), (i = o._startTime + o._totalDuration / o._timeScale) > n && (n = i), o = t;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(e) {
            ...
            return g.constructor = m, g.getRatio = function(e) {
                ...
                for (var i, n, o, r, s, a, l = (t = t || {}).taper || "none", c = [], u = 0, d = 0 | (t.points || 20), f = d, p = !1 !== t.randomize, m = !0 === t.clamp, g = t.template instanceof e ? t.template : null, v = "number" == typeof t.strength ? .4 * t.strength : .4; --f > -1;) i = p ? Math.random() : 1 / d * f, n = g ? g.getRatio(i) : i, "none" === l ? o = v : "out" === l ? o = (r = 1 - i) * r * v : "in" === l ? o = i * i * v : .5 > i ? o = (r = 2 * i) * r * .5 * v : o = (r = 2 * (1 - i)) * r * .5 * v, p ? n += Math.random() * o - .5 * o : f % 2 ? n += .5 * o : n -= .5 * o, m && (n > 1 ? n = 1 : 0 > n && (n = 0)), c[u++] = {
                    x: i,
                    y: n
                };
            ...
            }, !0), u(o.SlowMo, "SlowMo", "ease,"), u(i, "RoughEase", "ease,"), u(t, "SteppedEase", "ease,"), p
        }, !0)
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(),
    function() {
        "use strict";
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(e, t) {
            ...
            var u, d, h, f, p, m, g, v, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                K = "",
                $ = function(e, t) {
                    var i, n, o = (t = t || B).style;
                    if (void 0 !== o[e]) return e;
                    for (e = e.charAt(0).toUpperCase() + e.substr(1), i = ["O", "Moz", "ms", "Ms", "Webkit"], n = 5; --n > -1 && void 0 === o[i[n] + e];);
                    return n >= 0 ? (G = "-" + (K = 3 === n ? "ms" : i[n]).toLowerCase() + "-", K + e) : null
                },
                Z = H.defaultView ? H.defaultView.getComputedStyle : function() {},
                J = s.getStyle = function(e, t, i, n, o) {
                    var r;
                    return X || "opacity" !== t ? (!n && e.style[t] ? r = e.style[t] : (i = i || Z(e)) ? r = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(k, "-$1").toLowerCase()) : e.currentStyle && (r = e.currentStyle[t]), null == o || r && "none" !== r && "auto" !== r && "auto auto" !== r ? r : o) : V(e)
                },
                ee = q.convertToPixels = function(e, i, n, o, r) {
                    if ("px" === o || !o) return n;
                    ...
                    var a, l, c, u = A.test(i),
                        ...
                        f = 0 > n,
                        p = 1 === n;
                    if (f && (n = -n), p && (n *= 100), "%" === o && -1 !== i.indexOf("border")) a = n / 100 * (u ? e.clientWidth : e.clientHeight);
                    else {
                        if (h.cssText = "border:0 solid red;position:" + J(e, "position") + ";line-height:0;", "%" !== o && d.appendChild && "v" !== o.charAt(0) && "rem" !== o) h[u ? "borderLeftWidth" : "borderTopWidth"] = n + o;
                        else {
                            if (l = (d = e.parentNode || H.body)._gsCache, c = t.ticker.frame, l && u && l.time === c) return l.width * n / 100;
                            h[u ? "width" : "height"] = n + o
                        }
                        d.appendChild(B), a = parseFloat(B[u ? "offsetWidth" : "offsetHeight"]), d.removeChild(B), u && "%" === o && !1 !== s.cacheWidths && ((l = d._gsCache = d._gsCache || {}).time = c, l.width = a / n * 100), 0 !== a || r || (a = ee(e, i, n, o, !0))
                    }
                ...
                ie = function(e, t) {
                    ...
                    if (t = t || Z(e, null))
                        if (i = t.length)
                            for (; --i > -1;)(-1 === (o = t[i]).indexOf("-transform") || Oe === o) && (r[o.replace(I, P)] = t.getPropertyValue(o));
                        else
                            for (i in t)(-1 === i.indexOf("Transform") || Ie === i) && (r[i] = t[i]);
                    else if (t = e.currentStyle || e.style)
                        for (i in t) "string" == typeof i && void 0 === r[i] && (r[i.replace(I, P)] = t[i]);
                    return X || (r.opacity = V(e)), n = Be(e, t, !1), r.rotation = n.rotation, r.skewX = n.skewX, r.scaleX = n.scaleX, r.scaleY = n.scaleY, r.x = n.x, r.y = n.y, Ae && (r.z = n.z, r.rotationX = n.rotationX, r.rotationY = n.rotationY, r.scaleZ = n.scaleZ), r.filters && delete r.filters, r
                },
                ne = function(e, t, i, n, o) {
                    var r, s, a, l = {},
                        c = e.style;
                    for (s in i) "cssText" !== s && "length" !== s && isNaN(s) && (t[s] !== (r = i[s]) || o && o[s]) && -1 === s.indexOf("Origin") && ("number" == typeof r || "string" == typeof r) && (l[s] = "auto" !== r || "left" !== s && "top" !== s ? "" !== r && "auto" !== r && "none" !== r || "string" != typeof t[s] || "" === t[s].replace(w, "") ? r : 0 : te(e, s), void 0 !== c[s] && (a = new ye(c, s, c[s], a)));
                    if (n)
                ...
                se = function(e, t, i) {
                    ...
                    var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
                        o = oe[t],
                        r = o.length;
                    for (i = i || Z(e, null); --r > -1;) n -= parseFloat(J(e, "padding" + o[r], i, !0)) || 0, n -= parseFloat(J(e, "border" + o[r] + "Width", i, !0)) || 0;
                    return n
                },
                ae = function(e, t) {
                ...
                ue = function(e, t, i, n) {
                    var o, r, s, a, l;
                    return "function" == typeof e && (e = e(v, g)), null == e ? a = t : "number" == typeof e ? a = e : (o = 360, r = e.split("_"), s = ((l = "=" === e.charAt(1)) ? parseInt(e.charAt(0) + "1", 10) * parseFloat(r[0].substr(2)) : parseFloat(r[0])) * (-1 === e.indexOf("rad") ? 1 : M) - (l ? 0 : t), r.length && (n && (n[i] = t + s), -1 !== e.indexOf("short") && ((s %= o) !== s % 180 && (s = 0 > s ? s + o : s - o)), -1 !== e.indexOf("_cw") && 0 > s ? s = (s + 9999999999 * o) % o - (s / o | 0) * o : -1 !== e.indexOf("ccw") && s > 0 && (s = (s - 9999999999 * o) % o - (s / o | 0) * o)), a = t + s), 1e-6 > a && a > -1e-6 && (a = 0), a
                },
                de = {
                    aqua: [0, 255, 255],
                    lime: [0, 255, 0],
                ...
                fe = s.parseColor = function(e, t) {
                    var i, n, o, r, s, a, l, c, u, d, h;
                    if (e)
                        if ("number" == typeof e) i = [e >> 16, e >> 8 & 255, 255 & e];
                        else {
                            if ("," === e.charAt(e.length - 1) && (e = e.substr(0, e.length - 1)), de[e]) i = de[e];
                            else if ("#" === e.charAt(0)) 4 === e.length && (n = e.charAt(1), o = e.charAt(2), r = e.charAt(3), e = "#" + n + n + o + o + r + r), i = [(e = parseInt(e.substr(1), 16)) >> 16, e >> 8 & 255, 255 & e];
                            else if ("hsl" === e.substr(0, 3))
                                if (i = h = e.match(y), t) {
                                    if (-1 !== e.indexOf("=")) return e.match(_)
                                } else s = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (o = .5 >= l ? l * (a + 1) : l + a - l * a), i.length > 3 && (i[3] = Number(e[3])), i[0] = he(s + 1 / 3, n, o), i[1] = he(s, n, o), i[2] = he(s - 1 / 3, n, o);
                            else i = e.match(y) || de.transparent;
                            i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                        }
                    else i = de.black;
                    return t && !h && (n = i[0] / 255, o = i[1] / 255, r = i[2] / 255, l = ((c = Math.max(n, o, r)) + (u = Math.min(n, o, r))) / 2, c === u ? s = a = 0 : (d = c - u, a = l > .5 ? d / (2 - c - u) : d / (c + u), s = c === n ? (o - r) / d + (r > o ? 6 : 0) : c === o ? (r - n) / d + 2 : (n - o) / d + 4, s *= 60), i[0] = s + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
                },
                pe = function(e, t) {
                    var i, n, o, r = e.match(me) || [],
                        s = 0,
                        a = r.length ? "" : e;
                    for (i = 0; i < r.length; i++) n = r[i], s += (o = e.substr(s, e.indexOf(n, s) - s)).length + n.length, 3 === (n = fe(n, t)).length && n.push(1), a += o + (t ? "hsla(" + n[0] + "," + n[1] + "%," + n[2] + "%," + n[3] : "rgba(" + n.join(",")) + ")";
                    return a + e.substr(s)
                },
            ...
            var ge = function(e, t, i, n) {
                    ...
                    return u ? o = t ? function(e) {
                        ...
                        if ("number" == typeof e) e += d;
                            ...
                            for (p = e.replace(j, "|").split("|"), f = 0; f < p.length; f++) p[f] = o(p[f]);
                            return p.join(",")
                        }
                        if (t = (e.match(me) || [r])[0], f = (h = e.split(t).join("").match(b) || []).length, u > f--)
                        ...
                        if ("number" == typeof e) e += d;
                            ...
                            for (r = e.replace(j, "|").split("|"), h = 0; h < r.length; h++) r[h] = o(r[h]);
                            return r.join(",")
                        }
                ...
                _e = (q._parseToProxy = function(e, t, i, n, o, r) {
                    var s, a, l, c, u, d = n,
                        h = {},
                        f = {},
                        p = i._transform,
                        m = N;
                    for (i._transform = null, N = t, n = u = i.parse(e, t, n, o), N = m, r && (i._transform = p, d && (d._prev = null, d._prev && (d._prev._next = null))); n && n !== d;) {
                        if (n.type <= 1 && (f[a = n.p] = n.s + n.c, h[a] = n.s, r || (c = new ye(n, "s", a, c, n.r), n.c = 0), 1 === n.type))
                            for (s = n.l; --s > 0;) l = "xn" + s, f[a = n.p + "_" + l] = n.data[l], h[a] = n[l], r || (c = new ye(n, l, a, c, n.rxp[l]));
                        n = n._next
                    }
                    return {
                        proxy: h,
                ...
                }, q.CSSPropTween = function(e, t, n, o, s, a, l, c, u, d, h) {
                    this.t = e, this.p = t, this.s = n, this.c = o, this.n = l || t, e instanceof _e || r.push(this.n), this.r = c, this.type = a || 0, u && (this.pr = u, i = !0), this.b = void 0 === d ? n : d, this.e = void 0 === h ? n + o : h, s && (this._next = s, s._prev = this)
                }),
                be = function(e, t, i, n, o, r) {
                    var s = new _e(e, t, i, n - i, o, -1, r);
                    return s.b = i, s.e = s.xs0 = n, s
                },
                we = s.parseComplex = function(e, t, i, n, o, r, a, l, c, d) {
                    i = i || r || "", "function" == typeof n && (n = n(v, g)), a = new _e(e, t, 0, 0, a, d ? 2 : 1, null, !1, l, i, n), n += "", o && me.test(n + i) && (n = [i, n], s.colorStringFilter(n), i = n[0], n = n[1]);
                    var h, f, p, m, b, w, x, S, T, C, E, k, I, O = i.split(", ").join(",").split(" "),
                        P = n.split(", ").join(",").split(" "),
                        A = O.length,
                        L = !1 !== u;
                    for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (O = O.join(" ").replace(j, ", ").split(" "), P = P.join(" ").replace(j, ", ").split(" "), A = O.length), A !== P.length && (A = (O = (r || "").split(" ")).length), a.plugin = c, a.setRatio = d, me.lastIndex = 0, h = 0; A > h; h++)
                        if (m = O[h], b = P[h], (S = parseFloat(m)) || 0 === S) a.appendXtra("", S, le(b, S), b.replace(_, ""), L && -1 !== b.indexOf("px"), !0);
                        else if (o && me.test(m)) k = ")" + ((k = b.indexOf(")") + 1) ? b.substr(k) : ""), I = -1 !== b.indexOf("hsl") && X, m = fe(m, I), b = fe(b, I), (T = m.length + b.length > 6) && !X && 0 === b[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(P[h]).join("transparent")) : (X || (T = !1), I ? a.appendXtra(T ? "hsla(" : "hsl(", m[0], le(b[0], m[0]), ",", !1, !0).appendXtra("", m[1], le(b[1], m[1]), "%,", !1).appendXtra("", m[2], le(b[2], m[2]), T ? "%," : "%" + k, !1) : a.appendXtra(T ? "rgba(" : "rgb(", m[0], b[0] - m[0], ",", !0, !0).appendXtra("", m[1], b[1] - m[1], ",", !0).appendXtra("", m[2], b[2] - m[2], T ? "," : k, !0), T && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (b.length < 4 ? 1 : b[3]) - m, k, !1))), me.lastIndex = 0;
                    else if (w = m.match(y)) {
                        if (!(x = b.match(_)) || x.length !== w.length) return a;
                        for (p = 0, f = 0; f < w.length; f++) E = w[f], C = m.indexOf(E, p), a.appendXtra(m.substr(p, C - p), Number(E), le(x[f], E), "", L && "px" === m.substr(C + E.length, 2), 0 === f), p = C + E.length;
                        a["xs" + a.l] += m.substr(p)
            ...
            c.xs0 = "", c._next = c._prev = c.xfirst = c.data = c.plugin = c.setRatio = c.rxp = null, c.appendXtra = function(e, t, i, n, o, r) {
                var s = this,
                    a = s.l;
                return s["xs" + a] += r && (a || s["xs" + a]) ? " " + e : e || "", i || 0 === a || s.plugin ? (s.l++, s.type = s.setRatio ? 2 : 1, s["xs" + s.l] = n || "", a > 0 ? (s.data["xn" + a] = t + i, s.rxp["xn" + a] = o, s["xn" + a] = t, s.plugin || (s.xfirst = new _e(s, "xn" + a, t, i, s.xfirst || s, 0, s.n, o, s.pr), s.xfirst.xs0 = 0), s) : (s.data = {
                    s: t + i
                }, s.rxp = {}, s.s = t, s.c = i, s.r = o, s)) : (s["xs" + a] += t + (n || ""), s)
            };
            var Se = function(e, t) {
                    t = t || {}, this.p = t.prefix && $(e) || e, l[e] = l[this.p] = this, this.format = t.formatter || ge(t.defaultValue, t.color, t.collapsible, t.multi), t.parser && (this.parse = t.parser), this.clrs = t.color, this.multi = t.multi, this.keyword = t.keyword, this.dflt = t.defaultValue, this.pr = t.priority || 0
                },
                Te = q._registerComplexSpecialProp = function(e, t, i) {
                    "object" != typeof t && (t = {
                        parser: i
                    });
                    var n, o = e.split(","),
                        r = t.defaultValue;
                    for (i = i || [r], n = 0; n < o.length; n++) t.prefix = 0 === n && t.prefix, t.defaultValue = i[n] || r, new Se(o[n], t)
                },
                    ...
                    if (!l[e]) {
                        ...
                        Te(e, {
                            parser: function(e, i, n, o, r, s, c) {
                                ...
                                return u ? (u._cssRegister(), l[n].parse(e, i, n, o, r, s, c)) : (Y("Error: " + t + " js file not loaded."), r)
                            }
                        })
                    }
                };
            (c = Se.prototype).parseComplex = function(e, t, i, n, o, r) {
                var s, a, l, c, u, d, h = this.keyword;
                if (this.multi && (j.test(i) || j.test(t) ? (a = t.replace(j, "|").split("|"), l = i.replace(j, "|").split("|")) : h && (a = [t], l = [i])), l) {
                    for (c = l.length > a.length ? l.length : a.length, s = 0; c > s; s++) t = a[s] = a[s] || this.dflt, i = l[s] = l[s] || this.dflt, h && ((u = t.indexOf(h)) !== (d = i.indexOf(h)) && (-1 === d ? a[s] = a[s].split(h).join("") : -1 === u && (a[s] += " " + h)));
                    t = a.join(", "), i = l.join(", ")
                }
                return we(e, this.p, t, i, this.clrs, this.dflt, n, this.pr, o, r)
            }, c.parse = function(e, t, i, n, r, s, a) {
                return this.parseComplex(e.style, this.format(J(e, this.p, o, !1, this.dflt)), this.format(t), r, s)
            }, s.registerSpecialProp = function(e, t, i) {
                Te(e, {
                    parser: function(e, n, o, r, s, a, l) {
                        var c = new _e(e, o, 0, 0, s, 2, o, !1, i);
                        return c.plugin = a, c.setRatio = t(e, n, r._tween, o), c
                    },
                    priority: i
                })
            ...
            var Ee, ke = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                Re = function() {
                    ...
                    return H.createElementNS && !n && (e = je("svg", ze), i = (t = je("rect", e, {
                        width: 100,
                        height: 50,
                        x: 100
                    })).getBoundingClientRect().width, t.style[Pe] = "50% 50%", t.style[Ie] = "scaleX(0.5)", n = i === t.getBoundingClientRect().width && !(f && Ae), ze.removeChild(e)), n
                }(),
                Me = function(e, t, i, n, o, r) {
                    var a, l, c, u, d, h, f, p, m, g, v, y, _, b, w = e._gsTransform,
                        x = We(e, !0);
                ...
                Ne = function(e) {
                    ...
                    return o ? n.insertBefore(this, o) : n.appendChild(this), ze.removeChild(i), this.style.cssText = r, t
                },
                Fe = function(e) {
                ...
                He = [1, 0, 0, 1, 0, 0],
                We = function(e, t) {
                    var i, n, o, r, s, a, l = e._gsTransform || new Le,
                        c = e.style;
                    if (Ie ? n = J(e, Oe, null, !0) : e.currentStyle && (n = (n = e.currentStyle.filter.match(L)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), (i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n) && Ie && ((a = "none" === Z(e).display) || !e.parentNode) && (a && (r = c.display, c.display = "block"), e.parentNode || (s = 1, ze.appendChild(e)), i = !(n = J(e, Oe, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, r ? c.display = r : a && Xe(c, "display"), s && ze.removeChild(e)), (l.svg || e.getCTM && Fe(e)) && (i && -1 !== (c[Ie] + "").indexOf("matrix") && (n = c[Ie], i = 0), o = e.getAttribute("transform"), i && o && (-1 !== o.indexOf("matrix") ? (n = o, i = 0) : -1 !== o.indexOf("translate") && (n = "matrix(1,0,0,1," + o.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return He;
                    for (o = (n || "").match(y) || [], xe = o.length; --xe > -1;) r = Number(o[xe]), o[xe] = (s = r - (r |= 0)) ? (1e5 * s + (0 > s ? -.5 : .5) | 0) / 1e5 + r : r;
                    return t && o.length > 6 ? [o[0], o[1], o[4], o[5], o[12], o[13]] : o
                },
                Be = q.getTransform = function(e, i, n, o) {
                    if (e._gsTransform && n && !o) return e._gsTransform;
                    var r, a, l, c, u, d, h = n && e._gsTransform || new Le,
                        f = h.scaleX < 0,
                        p = 1e5,
                        m = Ae && (parseFloat(J(e, Pe, i, !1, "0 0 0").split(" ")[2]) || h.zOrigin) || 0,
                        g = parseFloat(s.defaultTransformPerspective) || 0;
                    if (h.svg = !(!e.getCTM || !Fe(e)), h.svg && (Me(e, J(e, Pe, i, !1, "50% 50%") + "", h, e.getAttribute("data-svg-origin")), Ee = s.useSVGTransformAttr || Re), (r = We(e)) !== He) {
                        if (16 === r.length) {
                            var v, y, _, b, w, x = r[0],
                                S = r[1],
                                T = r[2],
            ...
            (c = Le.prototype).x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0, c.scaleX = c.scaleY = c.scaleZ = 1, Te("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                ...
                parser: function(e, t, i, r, s, a) {
                    t = this.format(t);
                    var l, c, u, d, h, f, p, m, g, v, y, _, b, w, x, S, T = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                        C = e.style;
                ...
                parser: function(e, t, i, n, r, s) {
                    var a, l, c, u, d, h, f = "background-position",
                        ...
                        v = this.format(t);
                    if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && ((h = J(e, "backgroundImage").replace(O, "")) && "none" !== h)) {
                        for (a = g.split(" "), l = v.split(" "), Q.setAttribute("src", h), c = 2; --c > -1;)(u = -1 !== (g = a[c]).indexOf("%")) !== (-1 !== l[c].indexOf("%")) && (d = 0 === c ? e.offsetWidth - Q.width : e.offsetHeight - Q.height, a[c] = u ? parseFloat(g) / 100 * d + "px" : parseFloat(g) / d * 100 + "%");
                        g = a.join(" ")
                    }
                ...
                parser: function(e, t, i, n, r, s) {
                    var a, l, c;
                    return 9 > m ? (l = e.currentStyle, c = 8 > m ? " " : ",", a = "rect(" + l.clipTop + c + l.clipRight + c + l.clipBottom + c + l.clipLeft + ")", t = this.format(t).split(",").join(c)) : (a = this.format(J(e, this.p, o, !1, this.dflt)), t = this.format(t)), this.parseComplex(e.style, a, t, r, s)
                }
            }), Te("textShadow", {
                ...
                parser: function(e, t, i, n, r, s) {
                    var a = J(e, "borderTopWidth", o, !1, "0px"),
                        ...
                        c = l[0].replace(x, "");
                    return "px" !== c && (a = parseFloat(a) / ee(e, "borderTopWidth", 1, c) + c), this.parseComplex(e.style, this.format(a + " " + J(e, "borderTopStyle", o, !1, "solid") + " " + J(e, "borderTopColor", o, !1, "#000")), l.join(" "), r, s)
                },
                color: !0,
                formatter: function(e) {
                    var t = e.split(" ");
                ...
                parser: function(e, t, i, n, o, r) {
                    ...
                    return new _e(s, a, 0, 0, o, -1, i, !1, 0, s[a], t)
                }
            });
            var Ue = function(e) {
                var t, i = this.t,
                    ...
                    o = this.s + this.c * e | 0;
                100 === o && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), t = !J(this.data, "filter")) : (i.filter = n.replace(C, ""), t = !0)), t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + o + ")"), -1 === n.indexOf("pacity") ? 0 === o && this.xn1 || (i.filter = n + " alpha(opacity=" + o + ")") : i.filter = n.replace(S, "opacity=" + o))
            };
            Te("opacity,alpha,autoAlpha", {
                ...
                parser: function(e, t, i, n, r, s) {
                    var a = parseFloat(J(e, "opacity", o, !1, "1")),
                        l = e.style,
                        c = "autoAlpha" === i;
                    return "string" == typeof t && "=" === t.charAt(1) && (t = ("-" === t.charAt(0) ? -1 : 1) * parseFloat(t.substr(2)) + a), c && 1 === a && "hidden" === J(e, "visibility", o) && 0 !== t && (a = 0), X ? r = new _e(l, "opacity", a, t - a, r) : ((r = new _e(l, "opacity", 100 * a, 100 * (t - a), r)).xn1 = c ? 1 : 0, l.zoom = 1, r.type = 2, r.b = "alpha(opacity=" + r.s + ")", r.e = "alpha(opacity=" + (r.s + r.c) + ")", r.data = e, r.plugin = s, r.setRatio = Ue), c && ((r = new _e(l, "visibility", 0, 0, r, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === t ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(r.n), n._overwriteProps.push(i)), r
                }
            });
            var Xe = function(e, t) {
            ...
            Te("className", {
                parser: function(e, t, n, r, s, a, l) {
                    var c, u, d, h, f, p = e.getAttribute("class") || "",
                        m = e.style.cssText;
                    if ((s = r._classNamePT = new _e(e, n, 0, 0, s, 2)).setRatio = Ve, s.pr = -11, i = !0, s.b = p, u = ie(e, o), d = e._gsClassPT) {
                        for (h = {}, f = d.data; f;) h[f.p] = 1, f = f._next;
                        d.setRatio(1)
                    }
                    return e._gsClassPT = s, s.e = "=" !== t.charAt(1) ? t : p.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""), e.setAttribute("class", s.e), c = ne(e, u, ie(e), l, h), e.setAttribute("class", p), s.data = c.firstMPT, e.style.cssText = m, s.xfirst = r.parse(e, c.difs, s, a)
                }
            });
            var Ye = function(e) {
                if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) s.cssText = "", o = !0;
                        ...
                        for (n = (t = this.e.split(" ").join("").split(",")).length; --n > -1;) i = t[n], l[i] && (l[i].parse === a ? o = !0 : i = "transformOrigin" === i ? Pe : l[i].p), Xe(s, i);
                    o && (Xe(s, Ie), (r = this.t._gsTransform) && (r.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
                }
            };
            for (Te("clearProps", {
                    parser: function(e, t, n, o, r) {
                        return (r = new _e(e, n, 0, 0, r, 2)).setRatio = Ye, r.e = t, r.pr = -10, r.data = o._tween, i = !0, r
                    }
            ...
            (c = s.prototype)._firstPT = c._lastParsedTransform = c._transform = null, c._onInitTween = function(e, t, a, c) {
                ...
                this._target = g = e, this._tween = a, this._vars = t, v = c, u = t.autoRound, i = !1, n = t.suffixMap || s.suffixMap, o = Z(e, ""), r = this._overwriteProps;
                var f, m, y, _, b, w, x, S, C, E = e.style;
                if (d && "" === E.zIndex && (("auto" === (f = J(e, "zIndex", o)) || "" === f) && this._addLazySet(E, "zIndex", 0)), "string" == typeof t && (_ = E.cssText, f = ie(e, o), E.cssText = _ + ";" + t, f = ne(e, f, ie(e)).difs, !X && T.test(t) && (f.opacity = parseFloat(RegExp.$1)), t = f, E.cssText = _), t.className ? this._firstPT = m = l.className.parse(e, t.className, "className", this, null, null, t) : this._firstPT = m = this.parse(e, t, null), this._transformType) {
                    for (C = 3 === this._transformType, Ie ? h && (d = !0, "" === E.zIndex && (("auto" === (x = J(e, "zIndex", o)) || "" === x) && this._addLazySet(E, "zIndex", 0)), p && this._addLazySet(E, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (C ? "visible" : "hidden"))) : E.zoom = 1, y = m; y && y._next;) y = y._next;
                    S = new _e(e, "transform", 0, 0, null, 2), this._linkCSSP(S, null, y), S.setRatio = Ie ? qe : Qe, S.data = this._transform || Be(e, o, !0), S.tween = a, S.pr = -1, r.pop()
                }
                if (i) {
                    for (; m;) {
                ...
                this._transform = this._transform || Be(this._target, o, !0), this._transformType = this._transform.svg && Ee || !e && 3 !== this._transformType ? 2 : 3
            };
            var Ge = function(e) {
            ...
            var Ke = function(e, t, i) {
                ...
                if (e.slice)
                    ...
                    for (o = (n = e.childNodes).length; --o > -1;) s = (r = n[o]).type, r.style && (t.push(ie(r)), i && i.push(r)), 1 !== s && 9 !== s && 11 !== s || !r.childNodes.length || Ke(r, t, i)
            };
            return s.cascadeTo = function(e, i, n) {
                ...
                for (e = l._targets || l.target, Ke(e, u, h), l.render(i, !0, !0), Ke(e, d), l.render(0, !0, !0), l._enabled(!0), o = h.length; --o > -1;)
                    if ((r = ne(h[o], u[o], d[o])).firstMPT) {
                        for (s in r = r.difs, n) f[s] && (r[s] = n[s]);
                        for (s in a = {}, r) a[s] = u[o][s];
                        c.push(t.fromTo(h[o], i, a, r))
                    } return c
            }, e.activate([s]), s
        }, !0)
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(),
...
! function(e) {
    ...
    var t = e.GreenSockGlobals || e,
        ...
        a = function(e, t, i, n) {
            var o;
            return (i = i || r(e, null)) ? o = (e = i.getPropertyValue(t.replace(s, "-$1").toLowerCase())) || i.length ? e : i[t] : e.currentStyle && (o = (i = e.currentStyle)[t]), n ? o : parseInt(o, 10) || 0
        },
        l = function(e) {
        ...
        p = " style='position:relative;display:inline-block;" + (o.all && !o.addEventListener ? "*display:inline;*zoom:1;'" : "'"),
        m = function(e, t) {
            var i = -1 !== (e = e || "").indexOf("++"),
                n = 1;
        ...
        w = function(e) {
            var t, i, n = _(e.childNodes),
                o = n.length;
            for (t = 0; o > t; t++)(i = n[t])._isSplit ? w(i) : (t && 3 === i.previousSibling.nodeType ? i.previousSibling.nodeValue += 3 === i.nodeType ? i.nodeValue : i.firstChild.nodeValue : 3 !== i.nodeType && e.insertBefore(i.firstChild, i), e.removeChild(i))
        },
        x = function(e, t, i, n, s, l, c) {
            var u, d, h, f, p, m, g, _, x, S, T, C, E = r(e),
                k = a(e, "paddingLeft", E),
                I = -999,
                O = a(e, "borderBottomWidth", E) + a(e, "borderTopWidth", E),
                P = a(e, "borderLeftWidth", E) + a(e, "borderRightWidth", E),
                A = a(e, "paddingTop", E) + a(e, "paddingBottom", E),
                L = a(e, "paddingLeft", E) + a(e, "paddingRight", E),
                D = .2 * a(e, "fontSize"),
                j = a(e, "textAlign", E, !0),
                z = [],
                R = [],
                ...
                W = s && -1 !== H.indexOf("lines") ? [] : null,
                B = -1 !== H.indexOf("words"),
                Q = -1 !== H.indexOf("chars"),
                q = "absolute" === t.position || !0 === t.absolute,
                U = t.linesClass,
                X = -1 !== (U || "").indexOf("++"),
                V = [];
            for (W && 1 === e.children.length && e.children[0]._isSplit && (e = e.children[0]), X && (U = U.split("++").join("")), h = (d = e.getElementsByTagName("*")).length, p = [], u = 0; h > u; u++) p[u] = d[u];
            if (W || q)
                for (u = 0; h > u; u++)((m = (f = p[u]).parentNode === e) || q || Q && !B) && (C = f.offsetTop, W && m && Math.abs(C - I) > D && "BR" !== f.nodeName && (g = [], W.push(g), I = C), q && (f._x = f.offsetLeft, f._y = C, f._w = f.offsetWidth, f._h = f.offsetHeight), W && ((f._isSplit && m || !Q && m || B && m || !B && f.parentNode.parentNode === e && !f.parentNode._isSplit) && (g.push(f), f._x -= k, b(f, e, N) && (f._wordEnd = !0)), "BR" === f.nodeName && f.nextSibling && "BR" === f.nextSibling.nodeName && W.push([])));
            for (u = 0; h > u; u++) m = (f = p[u]).parentNode === e, "BR" !== f.nodeName ? (q && (x = f.style, B || m || (f._x += f.parentNode._x, f._y += f.parentNode._y), x.left = f._x + "px", x.top = f._y + "px", x.position = "absolute", x.display = "block", x.width = f._w + 1 + "px", x.height = f._h + "px"), !B && Q ? f._isSplit ? (f._next = f.nextSibling, f.parentNode.appendChild(f)) : f.parentNode._isSplit ? (f._parent = f.parentNode, !f.previousSibling && f.firstChild && (f.firstChild._isFirst = !0), f.nextSibling && " " === f.nextSibling.textContent && !f.nextSibling.nextSibling && V.push(f.nextSibling), f._next = f.nextSibling && f.nextSibling._isFirst ? null : f.nextSibling, f.parentNode.removeChild(f), p.splice(u--, 1), h--) : m || (C = !f.nextSibling && b(f.parentNode, e, N), f.parentNode._parent && f.parentNode._parent.appendChild(f), C && f.parentNode.appendChild(o.createTextNode(" ")), t.span && (f.style.display = "inline"), z.push(f)) : f.parentNode._isSplit && !f._isSplit && "" !== f.innerHTML ? R.push(f) : Q && !f._isSplit && (t.span && (f.style.display = "inline"), z.push(f))) : W || q ? (f.parentNode && f.parentNode.removeChild(f), p.splice(u--, 1), h--) : B || e.appendChild(f);
            for (u = V.length; --u > -1;) V[u].parentNode.removeChild(V[u]);
            if (W) {
                for (q && (S = o.createElement(F), e.appendChild(S), T = S.offsetWidth + "px", C = S.offsetParent === e ? 0 : e.offsetLeft, e.removeChild(S)), x = e.style.cssText, e.style.cssText = "display:none;"; e.firstChild;) e.removeChild(e.firstChild);
                for (_ = " " === N && (!q || !B && !Q), u = 0; u < W.length; u++) {
                    for (g = W[u], (S = o.createElement(F)).style.cssText = "display:block;text-align:" + j + ";position:" + (q ? "absolute;" : "relative;"), U && (S.className = U + (X ? u + 1 : "")), M.push(S), h = g.length, d = 0; h > d; d++) "BR" !== g[d].nodeName && (f = g[d], S.appendChild(f), _ && f._wordEnd && S.appendChild(o.createTextNode(" ")), q && (0 === d && (S.style.top = f._y + "px", S.style.left = k + C + "px"), f.style.top = "0px", C && (f.style.left = f._x - C + "px")));
                    0 === h ? S.innerHTML = "&nbsp;" : B || Q || (w(S), v(S, String.fromCharCode(160), " ")), q && (S.style.width = T, S.style.height = f._h + "px"), e.appendChild(S)
                }
                e.style.cssText = x
            }
            q && (c > e.clientHeight && (e.style.height = c - A + "px", e.clientHeight < c && (e.style.height = c + O + "px")), l > e.clientWidth && (e.style.width = l - L + "px", e.clientWidth < l && (e.style.width = l + P + "px"))), y(i, z), y(n, R), y(s, M)
        },
        S = function(e, t, i, r) {
            var s, a, l, p, m, g, y, _, b, w = t.span ? "span" : "div",
                x = t.type || t.split || "chars,words,lines",
                S = (x.indexOf("words"), -1 !== x.indexOf("chars")),
                ...
                P = e.parentNode;
            for (P.insertBefore(O, e), O.textContent = e.nodeValue, P.removeChild(e), y = -1 !== (s = n(e = O)).indexOf("<"), !1 !== t.reduceWhiteSpace && (s = s.replace(u, " ").replace(c, "")), y && (s = s.split("<").join("{{LT}}")), m = s.length, a = (" " === s.charAt(0) ? E : "") + i(), l = 0; m > l; l++)
                if ((g = s.charAt(l)) === C && s.charAt(l - 1) !== C && l) {
                    for (a += I ? k : "", I = !1; s.charAt(l + 1) === C;) a += E, l++;
                    l === m - 1 ? a += E : ")" !== s.charAt(l + 1) && (a += E + i(), I = !0)
                } else "{" === g && "{{LT}}" === s.substr(l, 6) ? (a += S ? r() + "{{LT}}</" + w + ">" : "{{LT}}", l += 5) : g.charCodeAt(0) >= 55296 && g.charCodeAt(0) <= 56319 || s.charCodeAt(l + 1) >= 65024 && s.charCodeAt(l + 1) <= 65039 ? (_ = f(s.substr(l, 2)), b = f(s.substr(l + 2, 2)), p = _ >= d && h >= _ && b >= d && h >= b || b >= 127995 && 127999 >= b ? 4 : 2, a += S && " " !== g ? r() + s.substr(l, p) + "</" + w + ">" : s.substr(l, p), l += p - 1) : a += S && " " !== g ? r() + g + "</" + w + ">" : g;
            e.outerHTML = a + (I ? k : ""), y && v(P, "{{LT}}", "<")
        },
        T = function(e, t, i, n) {
            var o, r, s = _(e.childNodes),
                l = s.length,
                c = "absolute" === t.position || !0 === t.absolute;
            if (3 !== e.nodeType || l > 1) {
                for (t.absolute = !1, o = 0; l > o; o++)(3 !== (r = s[o]).nodeType || /\S+/.test(r.nodeValue)) && (c && 3 !== r.nodeType && "inline" === a(r, "display", null, !0) && (r.style.display = "inline-block", r.style.position = "relative"), r._isSplit = !0, T(r, t, i, n));
    ...
    C.split = function(e) {
        ...
        for (var t, i, n, o = this.elements.length, r = e.span ? "span" : "div", s = ("absolute" === e.position || e.absolute, m(e.wordsClass, r)), a = m(e.charsClass, r); --o > -1;) n = this.elements[o], this._originals[o] = n.innerHTML, t = n.clientHeight, i = n.clientWidth, T(n, e, s, a), x(n, e, this.chars, this.words, this.lines, i, t);
    ...
    function(jQuery, undefined) {
        ...
        jQuery.fn.extend({
            revolution: function(e) {
                ...
                return e = jQuery.extend(!0, {}, t, e), this.each(function() {
                    ...
                    }), e.jsFileLocation = e.jsFileLocation || getScriptLocation("themepunch.revolution.min.js"), e.jsFileLocation = e.jsFileLocation + e.extensions, e.scriptsneeded = getNeededScripts(e, t), e.curWinRange = 0, e.rtl = !0, e.navigation != undefined && e.navigation.touch != undefined && (e.navigation.touch.swipe_min_touches = 5 < e.navigation.touch.swipe_min_touches ? 1 : e.navigation.touch.swipe_min_touches), jQuery(this).on("scriptsloaded", function() {
            ...
            revremoveslide: function(e) {
                return this.each(function() {
                    var t = jQuery(this),
                        i = t[0].opt;
                    if (!(e < 0 || e > i.slideamount) && t != undefined && 0 < t.length && 0 < jQuery("body").find("#" + t.attr("id")).length && i && 0 < i.li.length && (0 < e || e <= i.li.length)) {
                        var n = jQuery(i.li[e]),
                            o = n.data("index"),
                            r = !1;
            ...
            revkill: function(e) {
                var t = this,
                    i = jQuery(this);
                if (punchgs.TweenLite.killDelayedCallsTo(_R.showHideNavElements), i != undefined && 0 < i.length && 0 < jQuery("body").find("#" + i.attr("id")).length) {
                    i.data("conthover", 1), i.data("conthover-changed", 1), i.trigger("revolution.slide.onpause");
                    var n = i.parent().find(".tp-bannertimer"),
                        o = i[0].opt;
                    o.tonpause = !0, i.trigger("stoptimer");
                    var r = "resize.revslider-" + i.attr("id");
                    jQuery(window).unbind(r), punchgs.TweenLite.killTweensOf(i.find("*"), !1), punchgs.TweenLite.killTweensOf(i, !1), i.unbind("hover, mouseover, mouseenter,mouseleave, resize"), r = "resize.revslider-" + i.attr("id"), jQuery(window).off(r), i.find("*").each(function() {
                        var e = jQuery(this);
                    ...
                    return i.empty(), i.html(), o = i = null, delete t.c, delete t.opt, delete t.container, !0
                }
                return !1
            },
            revpause: function() {
            ...
            revshowslide: function(e) {
                return this.each(function() {
                    var t = jQuery(this);
                    t != undefined && 0 < t.length && 0 < jQuery("body").find("#" + t.attr("id")).length && _R.callingNewSlide(t, "to" + (e - 1))
                })
            },
            revcallslidewithid: function(e) {
                return this.each(function() {
                    var t = jQuery(this);
                    t != undefined && 0 < t.length && 0 < jQuery("body").find("#" + t.attr("id")).length && _R.callingNewSlide(t, e)
                })
            }
        });
        ...
        jQuery.extend(!0, _R, {
            ...
            setSize: function(e) {
                ...
                if (o = (o = o < e.minHeight ? e.minHeight : o) < r ? r : o, "fullwidth" == e.sliderLayout && "off" == e.autoHeight && punchgs.TweenLite.set(e.c, {
                        maxHeight: o + "px"
                    }), e.c.css({
                        marginTop: i,
                        marginBottom: n
            ...
            enterInViewPort: function(e) {
                ...
                }, 500)), "playing" != e.sliderlaststatus && e.sliderlaststatus != undefined || e.c.trigger("starttimer"), e.lastplayedvideos != undefined && 0 < e.lastplayedvideos.length && jQuery.each(e.lastplayedvideos, function(t, i) {
                    _R.playVideo(i, e)
                })
            },
            leaveViewPort: function(e) {
                e.sliderlaststatus = e.sliderstatus, e.c.trigger("stoptimer"), e.playingvideos != undefined && 0 < e.playingvideos.length && (e.lastplayedvideos = jQuery.extend(!0, [], e.playingvideos), e.playingvideos && jQuery.each(e.playingvideos, function(t, i) {
                    e.leaveViewPortBasedStop = !0, _R.stopVideo && _R.stopVideo(i, e)
                }))
            },
            unToggleState: function(e) {
                e != undefined && 0 < e.length && jQuery.each(e, function(e, t) {
        ...
        var _ISM = _R.is_mobile(),
            ...
            lAjax = function(e, t) {
                return !jQuery("body").data(e) && (t.filesystem ? (t.errorm === undefined && (t.errorm = "<br>Local Filesystem Detected !<br>Put this to your header:"), console.warn("Local Filesystem detected !"), t.errorm = t.errorm + '<br>&lt;script type="text/javascript" src="' + t.jsFileLocation + e + t.extensions_suffix + '"&gt;&lt;/script&gt;', console.warn(t.jsFileLocation + e + t.extensions_suffix + " could not be loaded !"), console.warn("Please use a local Server or work online or make sure that you load all needed Libraries manually in your Document."), console.log(" "), !(t.modulesfailing = !0)) : (jQuery.ajax({
            ...
            waitForScripts = function(e, t) {
                var i = !0,
                    n = t.scriptsneeded;
                t.addons != undefined && 0 < t.addons.length && jQuery.each(t.addons, function(e, t) {
            ...
            setCurWinRange = function(e, t) {
                ...
                a && a.length && jQuery.each(a, function(e, t) {
                    s < t && (0 == n || t < n) && (r = e, n = i = t), t < s && n < t && (n = t, o = e)
            ...
            runSlider = function(e, t) {
                ...
                if (t.inli = t.ul.find(">li.tp-invisible-slide"), t.thumbs = new Array, t.slots = 4, t.act = -1, t.firststart = 1, t.loadqueue = new Array, t.syncload = 0, t.conw = e.width(), t.conh = e.height(), 1 < t.responsiveLevels.length ? t.responsiveLevels[0] = 9999 : t.responsiveLevels = 9999, jQuery.each(t.allli, function(e, i) {
                        var n = (i = jQuery(i)).find(".rev-slidebg") || i.find("img").first(),
                            o = 0;
                        i.addClass("tp-revslider-slidesli"), i.data("index") === undefined && i.data("index", "rs-" + Math.round(999999 * Math.random()));
                        var r = new Object;
                        for (r.params = new Array, r.id = i.data("index"), r.src = i.data("thumb") !== undefined ? i.data("thumb") : n.data("lazyload") !== undefined ? n.data("lazyload") : n.attr("src"), i.data("title") !== undefined && r.params.push({
                                from: RegExp("\\{\\{title\\}\\}", "g"),
                                to: i.data("title")
                            }), i.data("description") !== undefined && r.params.push({
                                from: RegExp("\\{\\{description\\}\\}", "g"),
                                to: i.data("description")
                            }), o = 1; o <= 10; o++) i.data("param" + o) !== undefined && r.params.push({
                            from: RegExp("\\{\\{param" + o + "\\}\\}", "g"),
                            to: i.data("param" + o)
                        });
                        if (t.thumbs.push(r), i.data("link") != undefined) {
                            var s = i.data("link"),
                                a = i.data("target") || "_self",
                                l = "back" === i.data("slideindex") ? 0 : 60,
                                c = i.data("linktoslide"),
                                u = c;
                            c != undefined && "next" != c && "prev" != c && t.allli.each(function() {
                                var e = jQuery(this);
                                e.data("origindex") + 1 == u && (c = e.data("index"))
                            }), "slide" != s && (c = "no");
                            var d = '<div class="tp-caption slidelink" style="cursor:pointer;width:100%;height:100%;z-index:' + l + ';" data-x="center" data-y="center" data-basealign="slide" ',
                            ...
                            d = "no" == c ? d + h + " >" : d + "data-actions='" + ("scroll_under" === c ? '[{"event":"click","action":"scrollbelow","offset":"100px","delay":"0"}]' : "prev" === c ? '[{"event":"click","action":"jumptoslide","slide":"prev","delay":"0.2"}]' : "next" === c ? '[{"event":"click","action":"jumptoslide","slide":"next","delay":"0.2"}]' : '[{"event":"click","action":"jumptoslide","slide":"' + c + '","delay":"0.2"}]') + "'" + h + " >", d += '<a style="width:100%;height:100%;display:block"', d = "slide" != s ? d + ' target="' + a + '" href="' + s + '"' : d, d += '><span style="width:100%;height:100%;display:block"></span></a></div>', i.append(d)
                        }
                    ...
                    l = l === undefined ? 0 : l, c = c === undefined ? 0 : c, a.wrap('<div class="forcefullwidth_wrapper_tp_banner" id="' + u + '" style="position:relative;width:100%;height:auto;margin-top:' + c + ";margin-bottom:" + l + '"></div>'), e.closest(".forcefullwidth_wrapper_tp_banner").append('<div class="tp-fullwidth-forcer" style="width:100%;height:' + e.height() + 'px"></div>'), e.parent().css({
                        marginTop: "0px",
                        marginBottom: "0px"
                    }), e.parent().css({
                        position: "absolute"
                ...
                if (t.shadow !== undefined && 0 < t.shadow && (e.parent().addClass("tp-shadow" + t.shadow), e.parent().append('<div class="tp-shadowcover"></div>'), e.parent().find(".tp-shadowcover").css({
                    ...
                    var d = jQuery.fn.jquery.split("."),
                        h = parseFloat(d[0]),
                        f = parseFloat(d[1]);
                    parseFloat(d[2] || "0"), 1 == h && f < 7 && e.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:' + d + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>"), 1 < h && (t.ie = !1);
                    var p = new Object;
                    p.addedyt = 0, p.addedvim = 0, p.addedvid = 0, t.scrolleffect.on && (t.scrolleffect.layers = new Array), e.find(".tp-caption, .rs-background-video-layer").each(function(e) {
                        var i = jQuery(this),
                            n = i.data(),
                            ...
                            l = !0,
                            c = !1;
                        n.startclasses = i.attr("class"), n.isparallaxlayer = 0 <= n.startclasses.indexOf("rs-parallax"), i.hasClass("tp-static-layer") && _R.handleStaticLayers && (_R.handleStaticLayers(i, t), t.scrolleffect.on && ("on" === t.scrolleffect.on_parallax_static_layers && n.isparallaxlayer || "on" === t.scrolleffect.on_static_layers && !n.isparallaxlayer) && (c = !0), l = !1);
                        ...
                        if (i.find("iframe").each(function() {
                            ...
                            }), 0 < d && i.data("iframes", !0), i.hasClass("tp-caption")) {
                            var h = i.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : "",
                                f = i.data(),
                                m = "",
                                g = f.type,
                                v = "row" === g || "column" === g ? "relative" : "absolute",
                                y = "";
                            "row" === g ? (i.addClass("rev_row").removeClass("tp-resizeme"), y = "rev_row_wrap") : "column" === g ? (m = f.verticalalign === undefined ? " vertical-align:bottom;" : " vertical-align:" + f.verticalalign + ";", y = "rev_column", i.addClass("rev_column_inner").removeClass("tp-resizeme"), i.data("width", "auto"), punchgs.TweenLite.set(i, {
                                width: "auto"
                            })) : "group" === g && i.removeClass("tp-resizeme");
                            var _ = "",
                                b = "";
                            "row" !== g && "group" !== g && "column" !== g ? (_ = "display:" + i.css("display") + ";", 0 < i.closest(".rev_column").length ? (i.addClass("rev_layer_in_column"), l = !1) : 0 < i.closest(".rev_group").length && (i.addClass("rev_layer_in_group"), l = !1)) : "column" === g && (l = !1), f.wrapper_class !== undefined && (y = y + " " + f.wrapper_class), f.wrapper_id !== undefined && (b = 'id="' + f.wrapper_id + '"');
                            var w = "";
                            i.hasClass("tp-no-events") && (w = ";pointer-events:none"), i.wrap("<div " + b + ' class="tp-parallax-wrap ' + y + '" style="' + m + " " + h + "position:" + v + ";" + _ + ";visibility:hidden" + w + '"><div class="tp-loop-wrap" style="' + h + "position:" + v + ";" + _ + ';"><div class="tp-mask-wrap" style="' + h + "position:" + v + ";" + _ + ';" ></div></div></div>'), l && t.scrolleffect.on && ("on" === t.scrolleffect.on_parallax_layers && n.isparallaxlayer || "on" === t.scrolleffect.on_layers && !n.isparallaxlayer) && t.scrolleffect.layers.push(i.parent()), c && t.scrolleffect.layers.push(i.parent()), "column" === g && (i.append('<div class="rev_column_bg rev_column_bg_man_sized" style="visibility:hidden"></div>'), i.closest(".tp-parallax-wrap").append('<div class="rev_column_bg rev_column_bg_auto_sized"></div>'));
                            var x = i.closest(".tp-loop-wrap");
                            jQuery.each(["pendulum", "rotate", "slideloop", "pulse", "wave"], function(e, t) {
                                var n = i.find(".rs-" + t),
                                    o = n.data() || "";
                                "" != o && (x.data(o), x.addClass("rs-" + t), n.children(0).unwrap(), i.data("loopanimation", "on"))
                            }), i.attr("id") === undefined && i.attr("id", "layer-" + Math.round(999999999 * Math.random())), checkIDS(t, i), punchgs.TweenLite.set(i, {
                                visibility: "hidden"
                            })
                        }
                        var S = i.data("actions");
                        S !== undefined && _R.checkActions(i, t, S), checkHoverDependencies(i, t), _R.checkVideoApis && (p = _R.checkVideoApis(i, t, p)), s || 1 != o && "true" != o && "1sttime" != r || "loopandnoslidestop" == a || i.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-once"), s || 1 != r && "true" != r && "on" != r && "no1sttime" != r || "loopandnoslidestop" == a || i.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-always")
                    ...
                    var m = getUrlVars("#")[0];
                    if (m.length < 9 && 1 < m.split("slide").length) {
                    ...
                    var v = t.viewPort;
                    t.inviewport = !1, v != undefined && v.enable && (jQuery.isNumeric(v.visible_area) || -1 !== v.visible_area.indexOf("%") && (v.visible_area = parseInt(v.visible_area) / 100), _R.scrollTicker && _R.scrollTicker(t, e)), "carousel" === t.sliderType && _R.prepareCarousel && (punchgs.TweenLite.set(t.ul, {
                        opacity: 0
                        ...
                        _R.manageNavigation && _R.manageNavigation(t), 1 < t.slideamount && (!v.enable || v.enable && t.inviewport ? countDown(e, t) : t.waitForCountDown = !0), setTimeout(function() {
            ...
            cArray = function(e, t) {
                ...
                if (e.length < t) {
                    i = e[e.length - 1];
                    for (var n = 0; n < t - e.length + 2; n++) e.push(i)
                }
                return e
            },
            checkHoverDependencies = function(e, t) {
                ...
                ("sliderenter" === i.start || i.frames !== undefined && i.frames[0] != undefined && "sliderenter" === i.frames[0].delay) && (t.layersonhover === undefined && (t.c.on("tp-mouseenter", function() {
                    t.layersonhover && jQuery.each(t.layersonhover, function(e, i) {
                        ...
                        i.data("closestli") === undefined && (i.data("closestli", n), i.data("staticli", o)), (0 < n.length && n.hasClass("active-revslide") || n.hasClass("processing-revslide") || 0 < o.length) && (i.data("animdirection", "in"), _R.playAnimationFrame && _R.playAnimationFrame({
                            caption: i,
                            opt: t,
                            frame: "frame_0",
                            triggerdirection: "in",
            ...
            containerResized = function(e, t) {
                if (e.trigger("revolution.slide.beforeredraw"), 1 == t.infullscreenmode && (t.minHeight = jQuery(window).height()), setCurWinRange(t), setCurWinRange(t, !0), !_R.resizeThumbsTabs || !0 === _R.resizeThumbsTabs(t)) {
                    ...
                    }, 100), t.lastconw = t.conw), _R.manageNavigation && _R.manageNavigation(t), _R.animateTheCaptions && 0 < e.find(".active-revslide").length && _R.animateTheCaptions({
                        slide: e.find(".active-revslide"),
                        opt: t,
                        recall: !0
                    }), "on" == n.data("kenburns") && _R.startKenBurn(n, t, n.data("kbtl") !== undefined ? n.data("kbtl").progress() : 0), "on" == i.data("kenburns") && _R.startKenBurn(i, t, i.data("kbtl") !== undefined ? i.data("kbtl").progress() : 0), _R.animateTheCaptions && 0 < e.find(".processing-revslide").length && _R.animateTheCaptions({
            ...
            prepareSlides = function(e, t) {
                ...
                e.parent().css({
                    ...
                    r = "none" === r || r === undefined ? "" : r, i.wrap('<div class="slotholder" style="position:absolute; top:0px; left:0px; z-index:0;width:100%;height:100%;"></div>'), o.appendTo(n.find(".slotholder"));
                    var s = i.data();
                    i.closest(".slotholder").data(s), 0 < o.length && s.bgparallax != undefined && (o.data("bgparallax", s.bgparallax), o.data("showcoveronpause", "on")), "none" != t.dottedOverlay && t.dottedOverlay != undefined && i.closest(".slotholder").append('<div class="tp-dottedoverlay ' + t.dottedOverlay + '"></div>');
                    var a = i.attr("src");
                    ...
                    var l, c = i.data("bgcolor");
                    l = c !== undefined && 0 <= c.indexOf("gradient") ? '"background:' + c + ';width:100%;height:100%;"' : '"background-color:' + c + ";background-repeat:" + s.bgrepeat + ";background-image:url(" + a + ");background-size:" + s.bgfit + ";background-position:" + s.bgposition + ';width:100%;height:100%;"', i.data("mediafilter", r), r = "on" === i.data("kenburns") ? "" : r;
                    var u = jQuery('<div class="tp-bgimg defaultimg ' + r + '" data-bgcolor="' + c + '" style=' + l + "></div>");
                    i.parent().append(u);
                    var d = document.createComment("Runtime Modification - Img tag is Still Available for SEO Goals in Source - " + i.get(0).outerHTML);
                    i.replaceWith(d), u.data(s), u.attr("src", a), "standard" !== t.sliderType && "undefined" !== t.sliderType || u.css({
                        opacity: 0
                    })
            ...
            imgLoaded = function(e, t, i) {
                t.syncload--, t.loadqueue && jQuery.each(t.loadqueue, function(t, n) {
                    var o = n.src.replace(/\.\.\/\.\.\//gi, ""),
                        ...
                        l = s + "/" + o,
                        c = abstorel(self.location.href, n.src);
            ...
            loadImages = function(e, t, i, n) {
                e.find("img,.defaultimg, .tp-svg-layer").each(function() {
                    var e = jQuery(this),
                        o = e.data("lazyload") !== undefined && "undefined" !== e.data("lazyload") ? e.data("lazyload") : e.data("svg_src") != undefined ? e.data("svg_src") : e.attr("src"),
            ...
            waitForCurrentImages = function(e, t, i) {
                ...
                e.find("img,.defaultimg, .tp-svg-layer").each(function() {
                    var i = jQuery(this),
                        o = i.data("lazyload") != undefined ? i.data("lazyload") : i.data("svg_src") != undefined ? i.data("svg_src") : i.attr("src"),
                        r = getLoadObj(t, o);
                    if (i.data("loaded") === undefined && r !== undefined && r.progress && r.progress.match(/loaded/g)) {
                        if (i.attr("src", r.src), "img" == r.type)
                            if (i.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", r.src) : -1 == r.src.indexOf("images/transparent.png") && -1 == r.src.indexOf("assets/transparent.png") || i.data("bgcolor") === undefined ? i.css({
                                ...
                                var s = i.data("ww"),
                                    a = i.data("hh");
                                i.data("owidth", r.width), i.data("oheight", r.height), s = s == undefined || "auto" == s || "" == s ? r.width : s, a = a == undefined || "auto" == a || "" == a ? r.height : a, !jQuery.isNumeric(s) && 0 < s.indexOf("%") && (a = s), i.data("ww", s), i.data("hh", a)
                            }
                    ...
                    if (r && r.progress && r.progress.match(/inprogress|inload|prepared/g) && (!r.error && jQuery.now() - i.data("start-to-load") < 5e3 ? n = !0 : (r.progress = "failed", r.reported_img || (r.reported_img = !0, console.warn(o + "  Could not be loaded !")))), 1 == t.youtubeapineeded && (!window.YT || YT.Player == undefined) && (n = !0, 5e3 < jQuery.now() - t.youtubestarttime && 1 != t.youtubewarning)) {
                        t.youtubewarning = !0;
                ...
                }), !_ISM && t.audioqueue && 0 < t.audioqueue.length && jQuery.each(t.audioqueue, function(e, t) {
            ...
            swapSlide = function(e) {
                var t = e[0].opt;
                if (clearTimeout(t.waitWithSwapSlide), 0 < e.find(".processing-revslide").length) return t.waitWithSwapSlide = setTimeout(function() {
                    swapSlide(e)
                }, 150), !1;
            ...
            swapSlideProgress = function(e, t) {
                ...
                var a = {};
                a.nextslide = n, a.currentslide = i, t.trigger("revolution.slide.onbeforeswap", a), s.transition = 1, s.videoplaying = !1, n.data("delay") != undefined ? (s.cd = 0, s.delay = n.data("delay")) : s.delay = s.origcd, "true" == n.data("ssop") || !0 === n.data("ssop") ? s.ssop = !0 : s.ssop = !1, t.trigger("nulltimer");
                var l, c = i.index(),
                    u = n.index();
                if (s.sdir = u < c ? 1 : 0, "arrow" == s.sc_indicator && (0 == c && u == s.slideamount - 1 && (s.sdir = 1), c == s.slideamount - 1 && 0 == u && (s.sdir = 0)), s.lsdir = s.lsdir === undefined ? s.sdir : s.lsdir, s.dirc = s.lsdir != s.sdir, s.lsdir = s.sdir, i.index() != n.index() && 1 != s.firststart && _R.removeTheCaptions && _R.removeTheCaptions(i, s), n.hasClass("rs-pause-timer-once") || n.hasClass("rs-pause-timer-always") ? s.videoplaying = !0 : t.trigger("restarttimer"), n.removeClass("rs-pause-timer-once"), s.currentSlide = i.index(), s.nextSlide = n.index(), "carousel" == s.sliderType) l = new punchgs.TimelineLite, _R.prepareCarousel(s, l), letItFree(t, r, o, n, i, l), s.transition = 0, s.firststart = 0;
                else {
                    (l = new punchgs.TimelineLite({
                        onComplete: function() {
                            letItFree(t, r, o, n, i, l)
                        }
                        ...
                        autoAlpha: 0,
                        zIndex: 20
                    }), "prepared" == n.data("differentissplayed") && (n.data("differentissplayed", "done"), n.data("transition", n.data("savedtransition")), n.data("slotamount", n.data("savedslotamount")), n.data("masterspeed", n.data("savedmasterspeed"))), n.data("fstransition") != undefined && "done" != n.data("differentissplayed") && (n.data("savedtransition", n.data("transition")), n.data("savedslotamount", n.data("slotamount")), n.data("savedmasterspeed", n.data("masterspeed")), n.data("transition", n.data("fstransition")), n.data("slotamount", n.data("fsslotamount")), n.data("masterspeed", n.data("fsmasterspeed")), n.data("differentissplayed", "prepared")), n.data("transition") == undefined && n.data("transition", "random");
                    var d = n.data("transition") !== undefined ? n.data("transition").split(",") : "fade",
                        h = n.data("nexttransid") == undefined ? -1 : n.data("nexttransid");
                    "on" == n.data("randomtransition") ? h = Math.round(Math.random() * d.length) : h += 1, h == d.length && (h = 0), n.data("nexttransid", h);
                    var f = d[h];
                    s.ie && ("boxfade" == f && (f = "boxslide"), "slotfade-vertical" == f && (f = "slotzoom-vertical"), "slotfade-horizontal" == f && (f = "slotzoom-horizontal")), _R.isIE(8) && (f = 11), l = _R.animateSlide(0, f, t, n, i, r, o, l), "on" == r.data("kenburns") && (_R.startKenBurn(r, s), l.add(punchgs.TweenLite.set(r, {
                        autoAlpha: 0
                    }))), l.pause()
                }
            ...
            letItFree = function(e, t, i, n, o, r) {
                ...
                })), e.find(".active-revslide").removeClass("active-revslide"), e.find(".processing-revslide").removeClass("processing-revslide").addClass("active-revslide"), s.act = n.index(), s.c.attr("data-slideactive", e.find(".active-revslide").data("index")), "scroll" != s.parallax.type && "scroll+mouse" != s.parallax.type && "mouse+scroll" != s.parallax.type || (s.lastscrolltop = -999, _R.scrollHandling(s)), r.clear(), i.data("kbtl") != undefined && (i.data("kbtl").reverse(), i.data("kbtl").timeScale(25)), "on" == t.data("kenburns") && (t.data("kbtl") != undefined ? (t.data("kbtl").timeScale(1), t.data("kbtl").play()) : _R.startKenBurn(t, s)), n.find(".rs-background-video-layer").each(function(e) {
                ...
                var a = {};
                if (a.slideIndex = n.index() + 1, a.slideLIIndex = n.index(), a.slide = n, a.currentslide = n, a.prevslide = o, s.last_shown_slide = o.index(), e.trigger("revolution.slide.onchange", a), e.trigger("revolution.slide.onafterswap", a), s.startWithSlide !== undefined && "done" !== s.startWithSlide && "carousel" === s.sliderType) {
                    for (var l = s.startWithSlide, c = 0; c <= s.li.length - 1; c++) jQuery(s.li[c]).data("originalindex") === s.startWithSlide && (l = c);
                ...
                0 != d && d <= u && s.c.revremoveslide(o.index());
                var h = -1 === s.nextSlide || s.nextSlide === undefined ? 0 : s.nextSlide;
                s.rowzones != undefined && (h = h > s.rowzones.length ? s.rowzones.length : h), s.rowzones != undefined && 0 < s.rowzones.length && s.rowzones[h] != undefined && 0 <= h && h <= s.rowzones.length && 0 < s.rowzones[h].length && _R.setSize(s)
            },
            ...
            countDown = function(e, t) {
                t.cd = 0, t.loop = 0, t.stopAfterLoops != undefined && -1 < t.stopAfterLoops ? t.looptogo = t.stopAfterLoops : t.looptogo = 9999999, t.stopAtSlide != undefined && -1 < t.stopAtSlide ? t.lastslidetoshow = t.stopAtSlide : t.lastslidetoshow = 999, t.stopLoop = "off", 0 == t.looptogo && (t.stopLoop = "on");
                ...
                i[0].tween = punchgs.TweenLite.fromTo(i, t.delay / 1e3, {
                    ...
                    onComplete: n,
                    delay: 1
                }), 1 < t.slideamount && (0 != t.stopAfterLoops || 1 != t.stopAtSlide) ? e.trigger("starttimer") : (t.noloopanymore = 1, e.trigger("nulltimer")), e.on("tp-mouseenter", function() {
